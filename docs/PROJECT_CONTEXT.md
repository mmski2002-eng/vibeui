...
- **Наполнение каталога волнами.** 285 items в 32 реестрах: компоненты —
  ...
  `faq`, `testimonials`, `footer`, `dashboard` (14), `ai` (3), `commerce` (6), `auth` (6). Вместе с hero, features и pricing блоки
