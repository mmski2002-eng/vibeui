...
- **Наполнение каталога волнами.** 399 items в 35 реестрах: компоненты —
  ...
  `calendar` (20), `card` (21), `carousel` (8), `checkbox` (8), `menu` (8),
  `inputs` (33), `display` (15),
  `feedback` (11), `navigation` (12), `tables` (10), `charts` (25); блоки — `hero` (3), `features`, `pricing`, `navbar`, `cta`,
