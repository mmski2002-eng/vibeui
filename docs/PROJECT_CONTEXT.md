...
- **Наполнение каталога волнами.** 113 items в 20 реестрах: компоненты —
  `buttons` (11), `accordion` (11), `alert` (20), `dialog` (14), `aspect` (8),
  `autocomplete` (12), `inputs` (6), `display` (5), `feedback` (4),
  `navigation` (6), `tables` (3), `charts` (3); блоки — `hero` (3), `features`, `pricing`, `navbar`, `cta`,
