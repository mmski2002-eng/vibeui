...
- **Наполнение каталога волнами.** 279 items в 31 реестре: компоненты —
  ...
  `faq`, `testimonials`, `footer`, `dashboard` (14), `ai` (3), `commerce` (6). Вместе с hero, features и pricing блоки
