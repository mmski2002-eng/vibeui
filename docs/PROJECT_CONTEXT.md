...
- **Наполнение каталога волнами.** 255 items в 30 реестрах: компоненты —
  ...
  `inputs` (20), `display` (10),
  `feedback` (11), `navigation` (12), `tables` (10), `charts` (10); блоки — `hero` (3), `features`, `pricing`, `navbar`, `cta`,
  `faq`, `testimonials`, `footer`, `dashboard` (4), `ai` (3). Вместе с hero, features и pricing блоки
