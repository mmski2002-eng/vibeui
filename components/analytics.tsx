  ...
  return (
    <>
      <Script id="ym" strategy="afterInteractive">
        {/* Сниппет исполняется повторно при ре-рендере, а к этому моменту
            загруженный tag.js уже подменил window.ym своим объектом — вызов
            init на нём падал с "ym is not a function" на каждой странице.
            Флаг отсекает второй проход, проверка типа страхует от гонки. */}
        {`if(!window.__vibeuiYm){window.__vibeuiYm=1;
(function(m,e,t,r,i,k,a){m[i]=m[i]||function(){(m[i].a=m[i].a||[]).push(arguments)};
m[i].l=1*new Date();
for(var j=0;j<document.scripts.length;j++){if(document.scripts[j].src===r){return;}}
k=e.createElement(t),a=e.getElementsByTagName(t)[0],k.async=1,k.src=r,a.parentNode.insertBefore(k,a)})
(window,document,"script","https://mc.yandex.ru/metrika/tag.js?id=${id}","ym");
if(typeof window.ym==="function"){window.ym(${id},"init",{ssr:true,webvisor:true,clickmap:true,trackLinks:true,accurateTrackBounce:true,referrer:document.referrer,url:location.href});}}`}
      </Script>
      <noscript>
        <div>
