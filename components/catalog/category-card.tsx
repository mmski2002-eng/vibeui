...
export function CategoryCard({
  ...
  return (
    <article className="bg-shell border-shell-card hover:border-shell-border-strong relative flex h-full flex-col overflow-hidden rounded-xl border p-0.5 shadow-sm shadow-black/5 transition-colors">
