...
export function CategoryCard({
  ...
  return (
    <article className="bg-shell-panel border-shell-card hover:border-shell-accent-line relative flex h-full w-full flex-col overflow-hidden rounded-xl border p-0.5 shadow-sm shadow-black/5 transition-colors">
