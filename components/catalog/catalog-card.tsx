...
export function CatalogCard({
  ...
  return (
    ...
    <article className="catalog-card bg-shell border-shell-card-strong relative flex h-full w-full flex-col rounded-2xl border p-0.5 shadow-sm shadow-black/5">
      <CardInteractive
        name={localized.name}
        kind={kind}
        category={category}
