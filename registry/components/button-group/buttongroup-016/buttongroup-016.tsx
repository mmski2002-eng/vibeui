...
--vibeui-buttongroup-016-fg:light-dark(oklch(0.26 0 265),oklch(0.94 0 265));
--vibeui-buttongroup-016-muted:color-mix(in oklab,var(--vibeui-buttongroup-016-fg) 68%,transparent);
--vibeui-buttongroup-016-locked:light-dark(oklch(0.72 0 265),oklch(0.55 0 265));
...
--vibeui-buttongroup-016-on:light-dark(oklch(0.96 0 0),oklch(0.3 0 0));
--vibeui-buttongroup-016-accent:light-dark(oklch(0.28 0 0),oklch(0.905 0 0));
...
[data-vibeui-block="buttongroup-016"] [data-part="track"]{display:flex;isolation:isolate;max-inline-size:100%;overflow-x:auto}
