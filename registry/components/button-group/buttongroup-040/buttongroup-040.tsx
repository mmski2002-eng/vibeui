...
--vibeui-buttongroup-040-soft:light-dark(oklch(0.97 0 265),oklch(0.34 0 0));
--vibeui-buttongroup-040-soft-hover:light-dark(oklch(0.94 0 0),oklch(0.39 0 0));
--vibeui-buttongroup-040-accent:light-dark(oklch(0.275 0 0),oklch(0.91 0 0));
