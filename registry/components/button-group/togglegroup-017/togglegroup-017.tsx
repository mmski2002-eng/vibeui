...
--vibeui-togglegroup-017-accent:light-dark(oklch(0.287 0 0),oklch(0.901 0 0));
...
transition:translate .22s cubic-bezier(0.2,0.7,0.3,1);color:oklch(from var(--vibeui-togglegroup-017-accent) clamp(0,(0.62 - l) * 100,1) 0 0);}
