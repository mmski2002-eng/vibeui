...
--vibeui-togglegroup-013-accent:light-dark(oklch(0.287 0 0),oklch(0.903 0 0));
...
:where(.dark,[data-theme="dark"]) [data-vibeui-block="togglegroup-013"]{color-scheme:dark}
...
transition:transform .12s ease;color:oklch(from var(--vibeui-togglegroup-013-accent) clamp(0,(0.62 - l) * 100,1) 0 0);}
