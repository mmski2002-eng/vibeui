...
--vibeui-togglegroup-012-accent:light-dark(oklch(0.3 0 0),oklch(0.903 0 0));
...
transition:height .2s ease;color:oklch(from var(--vibeui-togglegroup-012-accent) clamp(0,(0.62 - l) * 100,1) 0 0);}
