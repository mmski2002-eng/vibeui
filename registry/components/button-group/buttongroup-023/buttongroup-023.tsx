...
--vibeui-buttongroup-023-accent:light-dark(oklch(0.275 0 0),oklch(0.91 0 0));
...
transition:transform .18s cubic-bezier(.2,.7,.3,1);color:oklch(from var(--vibeui-buttongroup-023-accent) clamp(0,(0.62 - l) * 100,1) 0 0);}
