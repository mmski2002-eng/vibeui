...
--vibeui-switch-014-bg:oklch(1 0 0);
--vibeui-switch-014-fg:oklch(0.22 0.014 265);
--vibeui-switch-014-muted:oklch(0.55 0.014 265);
--vibeui-switch-014-border:oklch(0.91 0.006 265);
--vibeui-switch-014-track:oklch(0.72 0.02 265);
--vibeui-switch-014-thumb:oklch(1 0 0);
--vibeui-switch-014-accent:oklch(0.55 0.16 155);
--vibeui-switch-014-mark:oklch(1 0 0 / 55%);
--vibeui-switch-014-mark-active:oklch(1 0 0 / 95%);
