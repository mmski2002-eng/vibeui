...
--vibeui-switch-010-surface:oklch(1 0 0);
--vibeui-switch-010-surface-border:oklch(0.91 0.006 265);
--vibeui-switch-010-fg:oklch(0.24 0.016 265);
--vibeui-switch-010-muted:oklch(0.54 0.014 265);
--vibeui-switch-010-track:oklch(0.88 0.008 265);
--vibeui-switch-010-thumb:oklch(1 0 0);
--vibeui-switch-010-accent:oklch(0.55 0.2 262);
--vibeui-switch-010-tint:oklch(0.55 0.2 262 / 12%);
--vibeui-switch-010-hover:oklch(0.55 0.02 265 / 7%);
...
background:var(--vibeui-switch-010-surface);
border:1px solid var(--vibeui-switch-010-surface-border);
...
export function Switch010({
  ...
  return (
    <>
      ...
      <label data-vibeui-block="switch-010" className={className} style={palette}>
