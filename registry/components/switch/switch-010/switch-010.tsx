...
export type Switch010Props = Omit<ComponentProps<"input">, "type" | "size"> & {
  label?: string
...
--vibeui-switch-010-border:light-dark(oklch(0.91 0 265),oklch(0.34 0 265));
--vibeui-switch-010-fg:light-dark(oklch(0.24 0 265),oklch(0.94 0 265));
...
:where(.dark,[data-theme="dark"]) [data-vibeui-block="switch-010"]{color-scheme:dark}
