...
--vibeui-eventcalendar-003-panel:light-dark(oklch(1 0 0),oklch(0.24 0 265));
--vibeui-eventcalendar-003-fg:light-dark(oklch(0.23 0 265),oklch(0.94 0 265));
...
:where(.dark,[data-theme="dark"]) [data-vibeui-block="eventcalendar-003"]{color-scheme:dark}
...
export function Eventcalendar003({
  ...
  const label = new Intl.DateTimeFormat(safeLocale(locale, "ru-RU"), {
    weekday: "long",
    day: "numeric",
    month: "long",
    timeZone: "UTC",
  }).format(safeDay(date, "2026-03-17"))
