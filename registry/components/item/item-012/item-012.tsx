...
--vibeui-item-012-accent:light-dark(oklch(0.295 0 0),oklch(0.905 0 0));
...
background:var(--vibeui-item-012-accent);visibility:hidden;color:oklch(from var(--vibeui-item-012-accent) clamp(0,(0.62 - l) * 100,1) 0 0);}
