...
--vibeui-item-006-accent:light-dark(oklch(0.55 0.19 39.8),oklch(0.75 0.16 39.8));
...
min-width:min(100%,16rem);max-width:30rem;box-sizing:border-box;padding:0.75rem 0.875rem;
list-style:none;
