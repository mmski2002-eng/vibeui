...
--vibeui-combobox-020-accent:light-dark(oklch(0.267 0 0),oklch(0.903 0 0));
--vibeui-combobox-020-accentsoft:light-dark(oklch(0.93 0 0),oklch(0.34 0 0));
...
background:var(--vibeui-combobox-020-accent);color:oklch(from var(--vibeui-combobox-020-accent) clamp(0,(0.62 - l) * 100,1) 0 0);
}
