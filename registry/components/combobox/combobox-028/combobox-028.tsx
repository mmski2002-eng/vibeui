...
--vibeui-combobox-028-active:light-dark(oklch(0.95 0.03 80),oklch(0.34 0.04 39.8));
--vibeui-combobox-028-accent:light-dark(oklch(0.55 0.14 39.8),oklch(0.79 0.14 39.8));
