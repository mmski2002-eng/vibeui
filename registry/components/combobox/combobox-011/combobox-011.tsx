...
--vibeui-combobox-011-active:light-dark(oklch(0.95 0 215),oklch(0.37 0.04 39.8));
--vibeui-combobox-011-accent:light-dark(oklch(0.52 0.12 39.8),oklch(0.78 0.12 39.8));
