...
--vibeui-combobox-005-active:light-dark(oklch(0.95 0 0),oklch(0.36 0 0));
--vibeui-combobox-005-accent:light-dark(oklch(0.275 0 0),oklch(0.91 0 0));
...
[data-vibeui-block="combobox-005"] [role="listbox"][hidden]{display:none}
