...
--vibeui-combobox-026-active:light-dark(oklch(0.95 0.035 39.8),oklch(0.34 0.045 39.8));
--vibeui-combobox-026-accent:light-dark(oklch(0.52 0.17 39.8),oklch(0.75 0.15 39.8));
