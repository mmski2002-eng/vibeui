...
--vibeui-combobox-008-active:light-dark(oklch(0.95 0.035 39.8),oklch(0.37 0.04 39.8));
--vibeui-combobox-008-accent:light-dark(oklch(0.55 0.17 39.8),oklch(0.76 0.15 39.8));
