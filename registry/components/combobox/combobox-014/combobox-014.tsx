...
--vibeui-combobox-014-accent:light-dark(oklch(0.5 0.13 39.8),oklch(0.72 0.13 39.8));
--vibeui-combobox-014-accentsoft:light-dark(oklch(0.94 0.04 39.8),oklch(0.36 0.06 39.8));
...
[data-vibeui-block="combobox-014"] [role="listbox"][hidden]{display:none}
