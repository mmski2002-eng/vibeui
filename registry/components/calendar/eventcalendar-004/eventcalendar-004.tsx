...
--vibeui-eventcalendar-004-accent:light-dark(oklch(0.287 0 0),oklch(0.903 0 0));
--vibeui-eventcalendar-004-personal:light-dark(oklch(0.3 0 0),oklch(0.906 0 0));
--vibeui-eventcalendar-004-deadline:light-dark(oklch(0.295 0 0),oklch(0.903 0 0));
