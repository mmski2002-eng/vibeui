...
--vibeui-scrollarea-006-accent:light-dark(oklch(0.55 0.19 39.8),oklch(0.74 0.16 39.8));
--vibeui-scrollarea-006-soft:light-dark(oklch(0.95 0 265),oklch(0.29 0.05 39.8));
