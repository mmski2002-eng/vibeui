...
--vibeui-dropdown-006-accent:light-dark(oklch(0.55 0.19 39.8),oklch(0.74 0.16 39.8));
...
:where(.dark,[data-theme="dark"]) [data-vibeui-block="dropdown-006"]{color-scheme:dark}
