...
--vibeui-contextmenu-008-accent:light-dark(oklch(0.287 0 0),oklch(0.906 0 0));
...
:where(.dark,[data-theme="dark"]) [data-vibeui-block="contextmenu-008"]{color-scheme:dark}
