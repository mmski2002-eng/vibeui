...
--vibeui-contextmenu-007-accent:light-dark(oklch(0.29 0 0),oklch(0.906 0 0));
...
background:var(--vibeui-contextmenu-007-accent);border-color:var(--vibeui-contextmenu-007-accent);color:oklch(from var(--vibeui-contextmenu-007-accent) clamp(0,(0.62 - l) * 100,1) 0 0);}
