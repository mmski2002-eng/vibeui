...
--vibeui-dropdown-020-accent:light-dark(oklch(0.52 0.19 39.8),oklch(0.72 0.16 39.8));
...
outline:2px solid var(--vibeui-dropdown-020-accent,light-dark(oklch(0.52 0.19 39.8),oklch(0.72 0.16 39.8)));
outline-offset:-2px;
}
