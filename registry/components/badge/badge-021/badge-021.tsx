...
export type Badge021Props = ComponentProps<"span"> & {
  env?: Badge021Env
  label?: string
}
...
:where(.dark,[data-theme="dark"]) [data-vibeui-block="badge-021"]{color-scheme:dark}
...
--vibeui-badge-021-bg:oklch(0.5 0.19 25);
...
--vibeui-badge-021-bg:light-dark(oklch(0.97 0.06 88),oklch(0.32 0.06 88));
--vibeui-badge-021-fg:light-dark(oklch(0.42 0.1 85),oklch(0.92 0.1 90));
--vibeui-badge-021-border:light-dark(oklch(0.85 0.12 88),oklch(0.52 0.1 88));
