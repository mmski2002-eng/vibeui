...
--vibeui-badge-005-bg:light-dark(oklch(0.96 0 265),oklch(0.27 0 265));
--vibeui-badge-005-fg:light-dark(oklch(0.3 0 265),oklch(0.93 0 265));
--vibeui-badge-005-border:light-dark(oklch(0.89 0 265),oklch(0.39 0 265));
--vibeui-badge-005-muted:color-mix(in oklab,var(--vibeui-badge-005-fg) 68%,transparent);
--vibeui-badge-005-accent:light-dark(oklch(0.55 0.17 39.8),oklch(0.74 0.15 39.8));
--vibeui-badge-005-hover:light-dark(oklch(0.91 0 265),oklch(0.36 0 265));
...
:where(.dark,[data-theme="dark"]) [data-vibeui-block="badge-005"]{color-scheme:dark}
