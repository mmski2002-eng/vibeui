...
--vibeui-autocomplete-010-fg:light-dark(oklch(0.22 0 265),oklch(0.94 0 265));
--vibeui-autocomplete-010-muted:color-mix(in oklab,var(--vibeui-autocomplete-010-fg) 68%,transparent);
--vibeui-autocomplete-010-border:light-dark(oklch(0.9 0 265),oklch(0.34 0 265));
--vibeui-autocomplete-010-field:light-dark(oklch(0.985 0 265),oklch(0.26 0 265));
--vibeui-autocomplete-010-panel:light-dark(oklch(1 0 0),oklch(0.24 0 265));
--vibeui-autocomplete-010-active:light-dark(oklch(0.95 0 265),oklch(0.33 0 265));
--vibeui-autocomplete-010-accent:light-dark(oklch(0.55 0.17 39.8),oklch(0.74 0.15 39.8));
