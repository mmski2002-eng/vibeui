...
--vibeui-autocomplete-007-fg:light-dark(oklch(0.22 0 265),oklch(0.94 0 265));
--vibeui-autocomplete-007-muted:color-mix(in oklab,var(--vibeui-autocomplete-007-fg) 68%,transparent);
--vibeui-autocomplete-007-border:light-dark(oklch(0.9 0 265),oklch(0.34 0 265));
--vibeui-autocomplete-007-field:light-dark(oklch(0.985 0 265),oklch(0.26 0 265));
--vibeui-autocomplete-007-panel:light-dark(oklch(1 0 0),oklch(0.24 0 265));
--vibeui-autocomplete-007-active:light-dark(oklch(0.95 0 265),oklch(0.33 0 265));
--vibeui-autocomplete-007-accent:light-dark(oklch(0.55 0.17 39.8),oklch(0.74 0.15 39.8));
