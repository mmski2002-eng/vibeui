...
--vibeui-togglegroup-010-bg:oklch(1 0 0);
--vibeui-togglegroup-010-fg:oklch(0.22 0.014 265);
--vibeui-togglegroup-010-muted:oklch(0.55 0.014 265);
--vibeui-togglegroup-010-border:oklch(0.9 0.006 265);
--vibeui-togglegroup-010-surface:oklch(0.97 0.004 265);
--vibeui-togglegroup-010-accent:oklch(0.56 0.19 320);
...
background:var(--vibeui-togglegroup-010-accent);color:oklch(0.99 0 0);
}
...
background:color-mix(in oklab,var(--vibeui-togglegroup-010-accent) 12%,white);
      ...
      >
        <div data-part="head">
          ...
          <p data-part="count" role="status">
            Активно: {value.length} из {MARKS.length}
          </p>
        </div>
