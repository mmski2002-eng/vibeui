...
--vibeui-togglegroup-011-accent:light-dark(oklch(0.56 0.16 39.8),oklch(0.76 0.14 39.8));
...
:where(.dark,[data-theme="dark"]) [data-vibeui-block="togglegroup-011"]{color-scheme:dark}
