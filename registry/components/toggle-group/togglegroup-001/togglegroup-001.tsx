...
--vibeui-togglegroup-001-fg:light-dark(oklch(0.22 0 265),oklch(0.94 0 265));
--vibeui-togglegroup-001-muted:color-mix(in oklab,var(--vibeui-togglegroup-001-fg) 68%,transparent);
--vibeui-togglegroup-001-border:light-dark(oklch(0.9 0 265),oklch(0.35 0 265));
--vibeui-togglegroup-001-surface:light-dark(oklch(0.97 0 265),oklch(0.26 0 265));
--vibeui-togglegroup-001-raised:light-dark(oklch(1 0 0),oklch(0.36 0 265));
--vibeui-togglegroup-001-shadow:light-dark(oklch(0.2 0 265 / 16%),oklch(0 0 0 / 45%));
--vibeui-togglegroup-001-accent:light-dark(oklch(0.55 0.17 39.8),oklch(0.74 0.15 39.8));
...
:where(.dark,[data-theme="dark"]) [data-vibeui-block="togglegroup-001"]{color-scheme:dark}
