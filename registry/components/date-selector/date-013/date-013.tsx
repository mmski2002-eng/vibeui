...
--vibeui-date-013-field:light-dark(oklch(1 0 0),oklch(0.26 0.012 265));
--vibeui-date-013-shell:light-dark(oklch(0.9 0.006 265),oklch(0.34 0.012 265));
--vibeui-date-013-fg:light-dark(oklch(0.23 0.014 265),oklch(0.94 0.005 265));
--vibeui-date-013-muted:color-mix(in oklab,var(--vibeui-date-013-fg) 68%,transparent);
--vibeui-date-013-border:light-dark(oklch(0.88 0.008 265),oklch(0.42 0.014 265));
--vibeui-date-013-panel:light-dark(oklch(1 0 0),oklch(0.24 0.012 265));
--vibeui-date-013-hover:light-dark(oklch(0.96 0.004 265),oklch(0.3 0.014 265));
--vibeui-date-013-shadow:light-dark(oklch(0.2 0.02 265 / 55%),oklch(0 0 0 / 70%));
--vibeui-date-013-accent:light-dark(oklch(0.52 0.15 175),oklch(0.76 0.13 175));
