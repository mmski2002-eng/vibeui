...
--vibeui-date-004-accent:light-dark(oklch(0.28 0 0),oklch(0.91 0 0));
...
background:var(--vibeui-date-004-accent);color:oklch(from var(--vibeui-date-004-accent) clamp(0,(0.62 - l) * 100,1) 0 0);}
