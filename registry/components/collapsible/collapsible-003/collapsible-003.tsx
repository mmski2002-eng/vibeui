...
--vibeui-collapsible-003-accent:light-dark(oklch(0.55 0.19 39.8),oklch(0.76 0.15 39.8));
...
:where(.dark,[data-theme="dark"]) [data-vibeui-block="collapsible-003"]{color-scheme:dark}
