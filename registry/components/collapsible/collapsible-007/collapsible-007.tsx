...
--vibeui-collapsible-007-muted:color-mix(in oklab,var(--vibeui-collapsible-007-fg) 68%,transparent);
...
:where(.dark,[data-theme="dark"]) [data-vibeui-block="collapsible-007"]{color-scheme:dark}
