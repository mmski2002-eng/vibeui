...
--vibeui-sparkline-005-accent:light-dark(oklch(0.55 0.17 39.8),oklch(0.74 0.15 39.8));
--vibeui-sparkline-005-band:color-mix(in oklab,var(--vibeui-sparkline-005-accent) 14%,transparent);
--vibeui-sparkline-005-breach:light-dark(oklch(0.55 0.19 39.8),oklch(0.74 0.16 39.8));
