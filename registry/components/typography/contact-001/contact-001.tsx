...
export type Contact001Props = Omit<ComponentProps<"span">, "title" | "children"> & {
  contactLabel?: string
  accent?: string
  className?: string
  style?: CSSProperties
...
--vibeui-contact-001-dur-2:180ms;
}
[data-vibeui-block="contact-001"]{box-sizing:border-box}
[data-vibeui-block="contact-001"] *{box-sizing:border-box}
[data-vibeui-block="contact-001"]{align-self:flex-start;color:inherit;text-decoration:none;
font-size:1.0625rem;font-weight:620;
border-bottom:2px solid currentColor;padding-bottom:0.125rem;
margin-bottom:1rem;
transition:opacity var(--vibeui-contact-001-dur-2) ease;}
[data-vibeui-block="contact-001"]:hover{opacity:.66}
