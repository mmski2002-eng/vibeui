...
--vibeui-avatar-015-accent:light-dark(oklch(0.287 0 0),oklch(0.894 0 0));
...
background:var(--vibeui-avatar-015-accent);color:oklch(from var(--vibeui-avatar-015-accent) clamp(0,(0.62 - l) * 100,1) 0 0);
