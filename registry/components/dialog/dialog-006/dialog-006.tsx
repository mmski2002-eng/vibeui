...
border:1px solid var(--vibeui-dialog-006-border,light-dark(oklch(0.89 0.006 265),oklch(0.38 0.012 265)));
border-radius:var(--vibeui-dialog-006-radius,1rem);
background:var(--vibeui-dialog-006-bg,light-dark(oklch(1 0 0),oklch(0.24 0.012 265)));
color:var(--vibeui-dialog-006-fg,light-dark(oklch(0.22 0.016 265),oklch(0.94 0.005 265)));
...
background:var(--vibeui-dialog-006-track,light-dark(oklch(0.93 0.006 265),oklch(0.33 0.01 265)));
}
