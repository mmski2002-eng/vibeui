...
--vibeui-dialog-006-accent:light-dark(oklch(0.55 0.2 262),oklch(0.72 0.18 262));
...
border:2px solid color-mix(in oklab,var(--vibeui-dialog-006-accent,light-dark(oklch(0.55 0.2 262),oklch(0.72 0.18 262))) 25%,transparent);
border-top-color:var(--vibeui-dialog-006-accent,light-dark(oklch(0.55 0.2 262),oklch(0.72 0.18 262)));
...
background:var(--vibeui-dialog-006-accent,light-dark(oklch(0.55 0.2 262),oklch(0.72 0.18 262)));
