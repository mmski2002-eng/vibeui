...
--vibeui-dialog-008-fg:light-dark(oklch(0.22 0 265),oklch(0.94 0 265));
--vibeui-dialog-008-muted:color-mix(in oklab,var(--vibeui-dialog-008-fg) 68%,transparent);
--vibeui-dialog-008-bg:light-dark(oklch(1 0 0),oklch(0.24 0 265));
--vibeui-dialog-008-panel:light-dark(oklch(0.975 0 265),oklch(0.3 0 265));
--vibeui-dialog-008-border:light-dark(oklch(0.89 0 265),oklch(0.38 0 265));
--vibeui-dialog-008-accent:light-dark(oklch(0.55 0.2 39.8),oklch(0.72 0.18 39.8));
...
border:1px solid var(--vibeui-dialog-008-border,light-dark(oklch(0.89 0 265),oklch(0.38 0 265)));
border-radius:var(--vibeui-dialog-008-radius,1rem);
background:var(--vibeui-dialog-008-bg,light-dark(oklch(1 0 0),oklch(0.24 0 265)));
color:var(--vibeui-dialog-008-fg,light-dark(oklch(0.22 0 265),oklch(0.94 0 265)));
...
[data-vibeui-dialog-008-window]::backdrop{background:oklch(0.18 0 265 / 45%)}
...
border:1px solid var(--vibeui-dialog-008-border,light-dark(oklch(0.89 0 265),oklch(0.38 0 265)));
border-radius:0.5rem;background:var(--vibeui-dialog-008-panel,light-dark(oklch(0.975 0 265),oklch(0.3 0 265)));
...
outline:none;border-color:var(--vibeui-dialog-008-accent,light-dark(oklch(0.55 0.2 39.8),oklch(0.72 0.18 39.8)));
box-shadow:0 0 0 3px color-mix(in oklab,var(--vibeui-dialog-008-accent,light-dark(oklch(0.55 0.2 39.8),oklch(0.72 0.18 39.8))) 20%,transparent);
}
...
background:var(--vibeui-dialog-008-accent,light-dark(oklch(0.55 0.2 39.8),oklch(0.72 0.18 39.8)));color:light-dark(oklch(1 0 0),oklch(0.17 0 265));
}
...
color:var(--vibeui-dialog-008-muted,light-dark(oklch(0.5 0 265),oklch(0.7 0 265)));
}
...
[data-vibeui-dialog-008-window] [data-part="role"]{margin-left:auto;font-size:0.75rem;color:var(--vibeui-dialog-008-muted,light-dark(oklch(0.5 0 265),oklch(0.7 0 265)))}
...
[data-vibeui-dialog-008-window] :focus-visible{outline:2px solid var(--vibeui-dialog-008-accent,light-dark(oklch(0.55 0.2 39.8),oklch(0.72 0.18 39.8)));outline-offset:2px}
...
[data-vibeui-block="dialog-008"]:has([data-open="true"]){display:block;width:100%}
[data-vibeui-block="dialog-008"]:has([data-open="true"]) [data-part="trigger"]{display:none}
[data-vibeui-dialog-008-window][data-open="true"]{
