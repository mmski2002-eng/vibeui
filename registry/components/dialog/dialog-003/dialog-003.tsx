...
--vibeui-dialog-003-fg:light-dark(oklch(0.22 0 265),oklch(0.94 0 265));
...
border:1px solid var(--vibeui-dialog-003-border,light-dark(oklch(0.89 0 265),oklch(0.38 0 265)));
border-radius:var(--vibeui-dialog-003-radius,1rem);
background:var(--vibeui-dialog-003-bg,light-dark(oklch(1 0 0),oklch(0.24 0 265)));
color:var(--vibeui-dialog-003-fg,light-dark(oklch(0.22 0 265),oklch(0.94 0 265)));
...
[data-vibeui-dialog-003-window]::backdrop{background:oklch(0.18 0 265 / 45%)}
...
border:1px solid var(--vibeui-dialog-003-border,light-dark(oklch(0.89 0 265),oklch(0.38 0 265)));
border-radius:0.5rem;background:light-dark(oklch(1 0 0),oklch(0.2 0 265));color:inherit;
...
color:var(--vibeui-dialog-003-muted,light-dark(oklch(0.5 0 265),oklch(0.7 0 265)));
}
...
[data-vibeui-dialog-003-window] [data-part="submit"]{background:var(--vibeui-dialog-003-accent,light-dark(oklch(0.55 0.2 262),oklch(0.72 0.18 262)));color:light-dark(oklch(1 0 0),oklch(0.17 0 265))}
