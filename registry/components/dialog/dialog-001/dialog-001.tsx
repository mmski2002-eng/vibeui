...
--vibeui-dialog-001-fg:light-dark(oklch(0.22 0 265),oklch(0.94 0 265));
...
--vibeui-dialog-001-accent:light-dark(oklch(0.58 0.2 25),oklch(0.72 0.19 25));
...
[data-vibeui-block="dialog-001"] [data-part="trigger"],
[data-vibeui-block="dialog-001"] [data-part="confirm"]{
background:var(--vibeui-dialog-001-accent);color:oklch(from var(--vibeui-dialog-001-accent) clamp(0,(0.62 - l) * 100,1) 0 0);
}
...
padding:1.375rem;border:1px solid var(--vibeui-dialog-001-border,light-dark(oklch(0.9 0 265),oklch(0.38 0 265)));
border-radius:var(--vibeui-dialog-001-radius,1rem);
background:var(--vibeui-dialog-001-bg,light-dark(oklch(1 0 0),oklch(0.24 0 265)));
color:var(--vibeui-dialog-001-fg,light-dark(oklch(0.22 0 265),oklch(0.94 0 265)));
...
background:oklch(0.18 0 265 / 45%);backdrop-filter:blur(2px);
}
[data-vibeui-dialog-001-window] [data-part="title"]{margin:0 0 0.375rem;font-size:1.0625rem;font-weight:600;line-height:1.35}
[data-vibeui-dialog-001-window] [data-part="body"]{margin:0;font-size:0.875rem;line-height:1.55;color:var(--vibeui-dialog-001-muted,light-dark(oklch(0.5 0 265),oklch(0.7 0 265)))}
...
[data-vibeui-block="dialog-001"]:has([data-open="true"]){display:block;width:100%}
[data-vibeui-block="dialog-001"]:has([data-open="true"]) [data-part="trigger"]{display:none}
[data-vibeui-dialog-001-window][data-open="true"]{
