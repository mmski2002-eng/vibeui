...
--vibeui-dialog-002-fg:light-dark(oklch(0.22 0 265),oklch(0.94 0 265));
--vibeui-dialog-002-muted:color-mix(in oklab,var(--vibeui-dialog-002-fg) 68%,transparent);
--vibeui-dialog-002-bg:light-dark(oklch(1 0 0),oklch(0.24 0 265));
--vibeui-dialog-002-border:light-dark(oklch(0.9 0 265),oklch(0.38 0 265));
...
padding:1.5rem;
border:1px solid var(--vibeui-dialog-002-border,light-dark(oklch(0.9 0 265),oklch(0.38 0 265)));
border-radius:var(--vibeui-dialog-002-radius,1rem);
background:var(--vibeui-dialog-002-bg,light-dark(oklch(1 0 0),oklch(0.24 0 265)));
color:var(--vibeui-dialog-002-fg,light-dark(oklch(0.22 0 265),oklch(0.94 0 265)));
...
[data-vibeui-dialog-002-window]::backdrop{background:oklch(0.18 0 265 / 50%);backdrop-filter:blur(2px)}
...
[data-vibeui-dialog-002-window] [data-part="description"]{margin:0;font-size:0.875rem;line-height:1.55;color:var(--vibeui-dialog-002-muted,light-dark(oklch(0.5 0 265),oklch(0.7 0 265)))}
...
font-size:0.8125rem;line-height:1.5;color:var(--vibeui-dialog-002-muted,light-dark(oklch(0.5 0 265),oklch(0.7 0 265)));
}
...
border-color:var(--vibeui-dialog-002-border,light-dark(oklch(0.9 0 265),oklch(0.38 0 265)));
}
[data-vibeui-dialog-002-window] [data-part="cancel"]:hover{background:color-mix(in oklab,var(--vibeui-dialog-002-border,light-dark(oklch(0.9 0 265),oklch(0.38 0 265))) 40%,transparent)}
