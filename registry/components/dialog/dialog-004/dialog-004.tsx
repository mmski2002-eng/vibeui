...
--vibeui-dialog-004-accent:light-dark(oklch(0.287 0 0),oklch(0.899 0 0));
...
border-color:var(--vibeui-dialog-004-accent,light-dark(oklch(0.287 0 0),oklch(0.899 0 0)));
background:color-mix(in oklab,var(--vibeui-dialog-004-accent,light-dark(oklch(0.287 0 0),oklch(0.899 0 0))) 6%,transparent);
}
...
border-color:var(--vibeui-dialog-004-accent,light-dark(oklch(0.287 0 0),oklch(0.899 0 0)));
box-shadow:inset 0 0 0 3.5px var(--vibeui-dialog-004-accent,light-dark(oklch(0.287 0 0),oklch(0.899 0 0)));
}
[data-vibeui-dialog-004-window] input:focus-visible{outline:2px solid var(--vibeui-dialog-004-accent,light-dark(oklch(0.287 0 0),oklch(0.899 0 0)));outline-offset:2px}
...
[data-vibeui-dialog-004-window] [data-part="submit"]{background:var(--vibeui-dialog-004-accent,light-dark(oklch(0.287 0 0),oklch(0.899 0 0)));color:light-dark(oklch(1 0 0),oklch(0.17 0 265))}
[data-vibeui-dialog-004-window] button:focus-visible{outline:2px solid var(--vibeui-dialog-004-accent,light-dark(oklch(0.287 0 0),oklch(0.899 0 0)));outline-offset:2px}
