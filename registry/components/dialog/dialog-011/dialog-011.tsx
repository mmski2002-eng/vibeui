...
--vibeui-dialog-011-accent:light-dark(oklch(0.287 0 0),oklch(0.899 0 0));
...
background:
radial-gradient(110% 90% at 18% 10%,color-mix(in oklab,var(--vibeui-dialog-011-accent,light-dark(oklch(0.287 0 0),oklch(0.899 0 0))) 55%,transparent),transparent 62%),
...
[data-vibeui-dialog-011-window] [data-part="primary"]{background:var(--vibeui-dialog-011-accent,light-dark(oklch(0.287 0 0),oklch(0.899 0 0)));color:light-dark(oklch(1 0 0),oklch(0.17 0 265))}
[data-vibeui-dialog-011-window] [data-part="primary"]:hover{filter:brightness(0.94)}
[data-vibeui-dialog-011-window] :focus-visible{outline:2px solid var(--vibeui-dialog-011-accent,light-dark(oklch(0.287 0 0),oklch(0.899 0 0)));outline-offset:2px}
