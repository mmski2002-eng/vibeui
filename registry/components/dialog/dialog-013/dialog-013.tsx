...
--vibeui-dialog-013-fg:light-dark(oklch(0.22 0 265),oklch(0.94 0 265));
--vibeui-dialog-013-muted:color-mix(in oklab,var(--vibeui-dialog-013-fg) 68%,transparent);
--vibeui-dialog-013-bg:light-dark(oklch(1 0 0),oklch(0.23 0 265));
...
--vibeui-dialog-013-accent:light-dark(oklch(0.287 0 0),oklch(0.899 0 0));
...
border:1px solid var(--vibeui-dialog-013-border,light-dark(oklch(0.89 0 265),oklch(0.36 0 265)));
border-radius:var(--vibeui-dialog-013-radius,1rem);
background:var(--vibeui-dialog-013-bg,light-dark(oklch(1 0 0),oklch(0.23 0 265)));
color:var(--vibeui-dialog-013-fg,light-dark(oklch(0.22 0 265),oklch(0.94 0 265)));
...
[data-vibeui-dialog-013-window]::backdrop{background:oklch(0.18 0 265 / 45%)}
[data-vibeui-dialog-013-window] [data-part="title"]{margin:0 0 0.25rem;font-size:1.0625rem;font-weight:620;line-height:1.35}
[data-vibeui-dialog-013-window] [data-part="description"]{margin:0 0 1rem;font-size:0.8125rem;line-height:1.5;color:var(--vibeui-dialog-013-muted,light-dark(oklch(0.5 0 265),oklch(0.7 0 265)))}
...
border-color:var(--vibeui-dialog-013-accent,light-dark(oklch(0.287 0 0),oklch(0.899 0 0)));
background:color-mix(in oklab,var(--vibeui-dialog-013-accent,light-dark(oklch(0.287 0 0),oklch(0.899 0 0))) 10%,transparent);
font-weight:600;
}
...
border:1px solid var(--vibeui-dialog-013-border,light-dark(oklch(0.89 0 265),oklch(0.36 0 265)));
border-radius:0.625rem;background:var(--vibeui-dialog-013-field,light-dark(oklch(1 0 0),oklch(0.2 0 265)));color:inherit;
font:inherit;font-size:0.875rem;line-height:1.5;
}
[data-vibeui-dialog-013-window] textarea:focus{
outline:none;border-color:var(--vibeui-dialog-013-accent,light-dark(oklch(0.287 0 0),oklch(0.899 0 0)));
box-shadow:0 0 0 3px color-mix(in oklab,var(--vibeui-dialog-013-accent,light-dark(oklch(0.287 0 0),oklch(0.899 0 0))) 20%,transparent);
}
...
[data-vibeui-dialog-013-window] [data-part="submit"]{background:var(--vibeui-dialog-013-accent,light-dark(oklch(0.287 0 0),oklch(0.899 0 0)));color:var(--vibeui-dialog-013-on-accent,light-dark(oklch(1 0 0),oklch(0.18 0 262)))}
[data-vibeui-dialog-013-window] [data-part="submit"]:hover{filter:brightness(0.94)}
[data-vibeui-dialog-013-window] :focus-visible{outline:2px solid var(--vibeui-dialog-013-accent,light-dark(oklch(0.287 0 0),oklch(0.899 0 0)));outline-offset:2px}
