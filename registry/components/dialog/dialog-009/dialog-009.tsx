...
--vibeui-dialog-009-fg:light-dark(oklch(0.22 0 265),oklch(0.94 0 265));
...
--vibeui-dialog-009-accent:light-dark(oklch(0.287 0 0),oklch(0.899 0 0));
...
border:1px solid var(--vibeui-dialog-009-border,light-dark(oklch(0.89 0 265),oklch(0.38 0 265)));
border-radius:var(--vibeui-dialog-009-radius,1rem);
background:var(--vibeui-dialog-009-bg,light-dark(oklch(1 0 0),oklch(0.24 0 265)));
color:var(--vibeui-dialog-009-fg,light-dark(oklch(0.22 0 265),oklch(0.94 0 265)));
...
[data-vibeui-dialog-009-window]::backdrop{background:oklch(0.18 0 265 / 45%)}
...
background:var(--vibeui-dialog-009-border,light-dark(oklch(0.89 0 265),oklch(0.38 0 265)));
...
[data-vibeui-dialog-009-window] [data-part="description"]{margin:0 0 0.875rem;font-size:0.8125rem;line-height:1.5;color:var(--vibeui-dialog-009-muted,light-dark(oklch(0.5 0 265),oklch(0.7 0 265)))}
...
outline:none;border-color:var(--vibeui-dialog-009-accent,light-dark(oklch(0.287 0 0),oklch(0.899 0 0)));
box-shadow:0 0 0 3px color-mix(in oklab,var(--vibeui-dialog-009-accent,light-dark(oklch(0.287 0 0),oklch(0.899 0 0))) 20%,transparent);
}
...
[data-vibeui-dialog-009-window] [data-part="submit"]{background:var(--vibeui-dialog-009-accent,light-dark(oklch(0.287 0 0),oklch(0.899 0 0)));color:light-dark(oklch(1 0 0),oklch(0.17 0 265))}
...
background:var(--vibeui-dialog-009-accent,light-dark(oklch(0.287 0 0),oklch(0.899 0 0)));
}
[data-vibeui-dialog-009-window] :focus-visible{outline:2px solid var(--vibeui-dialog-009-accent,light-dark(oklch(0.287 0 0),oklch(0.899 0 0)));outline-offset:2px}
