...
--vibeui-command-008-bg:light-dark(oklch(1 0 0),oklch(0.21 0 265));
--vibeui-command-008-fg:light-dark(oklch(0.23 0 265),oklch(0.94 0 265));
--vibeui-command-008-muted:color-mix(in oklab,var(--vibeui-command-008-fg) 68%,transparent);
--vibeui-command-008-border:light-dark(oklch(0.9 0 265),oklch(0.35 0 265));
--vibeui-command-008-accent:light-dark(oklch(0.55 0.19 39.8),oklch(0.75 0.15 39.8));
--vibeui-command-008-mark:light-dark(oklch(0.85 0.16 39.8 / 60%),oklch(0.55 0.13 39.8 / 60%));
--vibeui-command-008-shadow:light-dark(oklch(0.2 0 265 / 60%),oklch(0.04 0 265 / 70%));
