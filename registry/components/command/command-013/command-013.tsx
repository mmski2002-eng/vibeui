...
--vibeui-command-013-accent:light-dark(oklch(0.29 0 0),oklch(0.906 0 0));
...
background:var(--vibeui-command-013-accent);color:oklch(from var(--vibeui-command-013-accent) clamp(0,(0.62 - l) * 100,1) 0 0);
}
