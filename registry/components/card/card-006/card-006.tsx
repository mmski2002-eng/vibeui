...
--vibeui-card-006-fg:light-dark(oklch(0.22 0 265),oklch(0.94 0 265));
--vibeui-card-006-muted:color-mix(in oklab,var(--vibeui-card-006-fg) 68%,transparent);
--vibeui-card-006-border:light-dark(oklch(0.91 0 265),oklch(0.36 0 265));
--vibeui-card-006-track:light-dark(oklch(0.93 0 265),oklch(0.33 0 265));
--vibeui-card-006-accent:light-dark(oklch(0.287 0 0),oklch(0.903 0 0));
--vibeui-card-006-late:light-dark(oklch(0.56 0.19 25),oklch(0.72 0.16 25));
--vibeui-card-006-status:light-dark(oklch(0.6 0 265),oklch(0.7 0 265));
--vibeui-card-006-chip-base:light-dark(oklch(1 0 0),oklch(0.27 0 265));
--vibeui-card-006-chip-ink:light-dark(oklch(0.2 0 265),oklch(0.97 0 265));
...
height:100%;border-radius:inherit;background:var(--vibeui-card-006-accent);color:oklch(from var(--vibeui-card-006-accent) clamp(0,(0.62 - l) * 100,1) 0 0);}
...
[data-vibeui-block="card-006"] [data-part="face"][data-empty="true"]{background:light-dark(oklch(0.92 0.05 var(--vibeui-card-006-hue,250)),oklch(0.33 0.07 var(--vibeui-card-006-hue,250)));}
[data-vibeui-block="card-006"] [data-part="face"] img{
