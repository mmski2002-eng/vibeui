...
--vibeui-card-004-accent:light-dark(oklch(0.287 0 0),oklch(0.903 0 0));
--vibeui-card-004-on-accent:light-dark(oklch(0.99 0 265),oklch(0.18 0 265));
--vibeui-card-004-sale:light-dark(oklch(0.29 0 0),oklch(0.892 0 0));
...
background:var(--vibeui-card-004-accent);color:oklch(from var(--vibeui-card-004-accent) clamp(0,(0.62 - l) * 100,1) 0 0);
