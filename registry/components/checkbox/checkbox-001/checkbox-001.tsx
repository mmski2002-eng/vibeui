...
--vibeui-checkbox-001-accent:light-dark(oklch(0.287 0 0),oklch(0.897 0 0));
...
border-color:var(--vibeui-checkbox-001-accent);color:oklch(from var(--vibeui-checkbox-001-accent) clamp(0,(0.62 - l) * 100,1) 0 0);}
