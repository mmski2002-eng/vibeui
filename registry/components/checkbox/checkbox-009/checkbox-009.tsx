...
--vibeui-checkbox-009-accent:light-dark(oklch(0.56 0.16 39.8),oklch(0.74 0.14 39.8));
--vibeui-checkbox-009-badge:light-dark(oklch(0.95 0 39.8),oklch(0.34 0.05 39.8));
