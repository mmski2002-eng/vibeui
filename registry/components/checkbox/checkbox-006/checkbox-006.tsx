...
--vibeui-checkbox-006-accent:light-dark(oklch(0.287 0 0),oklch(0.901 0 0));
...
[data-vibeui-block="checkbox-006"] input:indeterminate{border-color:transparent;background:var(--vibeui-checkbox-006-accent);color:oklch(from var(--vibeui-checkbox-006-accent) clamp(0,(0.62 - l) * 100,1) 0 0);}
