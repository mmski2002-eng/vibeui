...
--vibeui-checkbox-010-accent:light-dark(oklch(0.52 0.15 39.8),oklch(0.74 0.13 39.8));
--vibeui-checkbox-010-soft:light-dark(oklch(0.96 0.03 168),oklch(0.3 0.05 39.8));
