...
--vibeui-radio-010-accent:light-dark(oklch(0.24 0.015 265),oklch(0.93 0.006 265));
--vibeui-radio-010-on-accent:light-dark(oklch(0.99 0 265),oklch(0.17 0.01 265));
...
:where(.dark,[data-theme="dark"]) [data-vibeui-block="radio-010"]{color-scheme:dark}
...
background:var(--vibeui-radio-010-accent);color:oklch(from var(--vibeui-radio-010-accent) clamp(0,(0.62 - l) * 100,1) 0 0);
}
