...
export type Checkbox005Props = Omit<ComponentProps<"div">, "children"> & {
  text?: string
  linkLabel?: string
  linkHref?: string
  error?: string
...
--vibeui-checkbox-005-accent:light-dark(oklch(0.287 0 0),oklch(0.901 0 0));
...
:where(.dark,[data-theme="dark"]) [data-vibeui-block="checkbox-005"]{color-scheme:dark}
...
[data-vibeui-block="checkbox-005"] [data-part="row"]{display:flex;align-items:flex-start;gap:0.625rem}
...
[data-vibeui-block="checkbox-005"] input:checked{border-color:transparent;background:var(--vibeui-checkbox-005-accent);color:oklch(from var(--vibeui-checkbox-005-accent) clamp(0,(0.62 - l) * 100,1) 0 0);}
...
display:flex;align-items:center;gap:0.375rem;padding-left:1.75rem;
