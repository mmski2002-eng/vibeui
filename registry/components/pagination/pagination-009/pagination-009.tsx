...
--vibeui-pagination-009-sheet:light-dark(oklch(1 0 0),oklch(0.23 0 265));
--vibeui-pagination-009-fg:light-dark(oklch(0.24 0 265),oklch(0.94 0 265));
...
:where(.dark,[data-theme="dark"]) [data-vibeui-block="pagination-009"]{color-scheme:dark}
...
border:1px solid var(--vibeui-pagination-009-border);border-radius:0.875rem;
font-family:var(--vibeui-pagination-009-font);
box-shadow:0 24px 48px -24px oklch(0.2 0 265 / 40%);
}
