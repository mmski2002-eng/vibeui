...
--vibeui-timeline-003-accent:light-dark(oklch(0.55 0.18 39.8),oklch(0.72 0.16 39.8));
--vibeui-timeline-003-on-accent:light-dark(oklch(1 0 0),oklch(0.18 0.04 39.8));
