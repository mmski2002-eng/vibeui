...
--vibeui-timeline-013-surface:light-dark(oklch(0.99 0.002 265),oklch(0.19 0.012 265));
--vibeui-timeline-013-fg:light-dark(oklch(0.22 0.014 265),oklch(0.94 0.005 265));
--vibeui-timeline-013-muted:color-mix(in oklab,var(--vibeui-timeline-013-fg) 68%,transparent);
--vibeui-timeline-013-border:light-dark(oklch(0.91 0.006 265),oklch(0.36 0.012 265));
--vibeui-timeline-013-line:light-dark(oklch(0.88 0.006 265),oklch(0.4 0.012 265));
