...
--vibeui-timeline-009-bg:oklch(1 0 0);
--vibeui-timeline-009-fg:oklch(0.22 0.014 265);
--vibeui-timeline-009-muted:oklch(0.57 0.014 265);
--vibeui-timeline-009-border:oklch(0.91 0.006 265);
--vibeui-timeline-009-track:oklch(0.9 0.006 265);
--vibeui-timeline-009-done:oklch(0.58 0.14 152);
--vibeui-timeline-009-accent:oklch(0.55 0.18 262);
...
box-shadow:0 0 0 3px var(--vibeui-timeline-009-bg),0 0 0 5px color-mix(in oklab,var(--vibeui-timeline-009-accent) 35%,transparent);
animation:vibeui-timeline-009-pulse 2.2s ease-in-out infinite;
}
@keyframes vibeui-timeline-009-pulse{
0%,100%{box-shadow:0 0 0 3px var(--vibeui-timeline-009-bg),0 0 0 5px color-mix(in oklab,var(--vibeui-timeline-009-accent) 35%,transparent)}
50%{box-shadow:0 0 0 3px var(--vibeui-timeline-009-bg),0 0 0 8px color-mix(in oklab,var(--vibeui-timeline-009-accent) 15%,transparent)}
}
            ...
            {stops.map((stop) => {
              ...
              return (
                <li key={stop.title} data-state={state}>
                  ...
                  <span data-part="sr">{STATE_LABEL[state]}</span>
