...
--vibeui-timeline-009-accent:light-dark(oklch(0.287 0 0),oklch(0.903 0 0));
...
animation:vibeui-timeline-009-pulse 2.2s ease-in-out infinite;color:oklch(from var(--vibeui-timeline-009-accent) clamp(0,(0.62 - l) * 100,1) 0 0);}
