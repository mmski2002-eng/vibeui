...
--vibeui-timeline-005-removed:light-dark(oklch(0.6 0.16 39.8),oklch(0.72 0.15 39.8));
--vibeui-timeline-005-accent:light-dark(oklch(0.55 0.18 39.8),oklch(0.74 0.16 39.8));
