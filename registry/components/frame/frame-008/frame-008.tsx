...
--vibeui-frame-008-body:oklch(0.93 0.004 265);
--vibeui-frame-008-bezel:oklch(0.86 0.006 265);
--vibeui-frame-008-screen:oklch(1 0 0);
--vibeui-frame-008-fg:oklch(0.24 0.014 265);
--vibeui-frame-008-muted:oklch(0.55 0.014 265);
--vibeui-frame-008-camera:oklch(0.4 0.01 265);
