...
--vibeui-popover-011-surface:oklch(1 0 0);
--vibeui-popover-011-fg:oklch(0.23 0.014 265);
--vibeui-popover-011-muted:oklch(0.53 0.014 265);
--vibeui-popover-011-border:oklch(0.89 0.006 265);
--vibeui-popover-011-accent:oklch(0.53 0.18 268);
...
background:var(--vibeui-popover-011-accent);border-color:var(--vibeui-popover-011-accent);color:oklch(1 0 0);
}
