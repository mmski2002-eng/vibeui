...
--vibeui-popover-012-accent:light-dark(oklch(0.5 0.16 39.8),oklch(0.78 0.12 39.8));
...
background:var(--vibeui-popover-012-accent);color:var(--vibeui-popover-012-on-accent);
