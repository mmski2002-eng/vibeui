...
export type Popover010Props = Omit<
...
--vibeui-popover-010-surface:oklch(1 0 0);
--vibeui-popover-010-fg:oklch(0.23 0.014 265);
--vibeui-popover-010-muted:oklch(0.53 0.014 265);
--vibeui-popover-010-border:oklch(0.89 0.006 265);
--vibeui-popover-010-accent:oklch(0.55 0.16 260);
...
background:var(--vibeui-popover-010-accent);color:oklch(1 0 0);
