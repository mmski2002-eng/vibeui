...
--vibeui-popover-010-accent:light-dark(oklch(0.287 0 0),oklch(0.903 0 0));
...
background:var(--vibeui-popover-010-accent);color:oklch(from var(--vibeui-popover-010-accent) clamp(0,(0.62 - l) * 100,1) 0 0);
