...
export type Phoneinput004Props = Omit<ComponentProps<"div">, "children"> & {
  label?: string
...
--vibeui-phoneinput-004-surface-border:light-dark(oklch(0.91 0 265),oklch(0.33 0 265));
--vibeui-phoneinput-004-fg:light-dark(oklch(0.24 0 265),oklch(0.94 0 265));
...
:where(.dark,[data-theme="dark"]) [data-vibeui-block="phoneinput-004"]{color-scheme:dark}
