...
export type Phoneinput001Props = Omit<ComponentProps<"div">, "children"> & {
  label?: string
  placeholder?: string
...
--vibeui-phoneinput-001-surface-border:light-dark(oklch(0.91 0 265),oklch(0.33 0 265));
--vibeui-phoneinput-001-fg:light-dark(oklch(0.24 0 265),oklch(0.94 0 265));
--vibeui-phoneinput-001-muted:color-mix(in oklab,var(--vibeui-phoneinput-001-fg) 68%,transparent);
--vibeui-phoneinput-001-field-border:light-dark(oklch(0.85 0 265),oklch(0.4 0 265));
--vibeui-phoneinput-001-accent:light-dark(oklch(0.55 0.2 39.8),oklch(0.72 0.17 39.8));
...
:where(.dark,[data-theme="dark"]) [data-vibeui-block="phoneinput-001"]{color-scheme:dark}
