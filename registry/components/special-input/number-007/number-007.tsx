...
[data-vibeui-block="number-007"] [data-part="tick"][data-on="true"]{background:var(--vibeui-number-007-accent);color:oklch(from var(--vibeui-number-007-accent) clamp(0,(0.62 - l) * 100,1) 0 0);}
