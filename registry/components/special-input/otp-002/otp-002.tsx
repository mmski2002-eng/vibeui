...
--vibeui-otp-002-accent:light-dark(oklch(0.28 0 0),oklch(0.903 0 0));
...
animation:vibeui-otp-002-blink 1.06s steps(2,start) infinite;color:oklch(from var(--vibeui-otp-002-accent) clamp(0,(0.62 - l) * 100,1) 0 0);}
