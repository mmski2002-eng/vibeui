...
--vibeui-scrollspy-004-accent:light-dark(oklch(0.287 0 0),oklch(0.906 0 0));
...
transition:height .12s linear;color:oklch(from var(--vibeui-scrollspy-004-accent) clamp(0,(0.62 - l) * 100,1) 0 0);}
