...
export type Scrollspy007Props = Omit<ComponentProps<"div">, "children"> & {
...
--vibeui-scrollspy-007-accent:light-dark(oklch(0.55 0.18 39.8),oklch(0.76 0.15 39.8));
...
:where(.dark,[data-theme="dark"]) [data-vibeui-block="scrollspy-007"]{color-scheme:dark}
...
export function Scrollspy007({
  ...
  const palette = {
    ...
    ...(background
      ? {
          "--vibeui-scrollspy-007-bg": background,
