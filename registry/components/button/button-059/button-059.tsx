...
--vibeui-button-059-accent:light-dark(oklch(0.275 0 0),oklch(0.881 0 0));
...
background:var(--vibeui-button-059-accent);color:oklch(from var(--vibeui-button-059-accent) clamp(0,(0.62 - l) * 100,1) 0 0);
