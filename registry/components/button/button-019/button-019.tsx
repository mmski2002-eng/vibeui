...
--vibeui-button-019-accent:light-dark(oklch(0.58 0.19 39.8),oklch(0.72 0.17 39.8));
...
:where(.dark,[data-theme="dark"]) [data-vibeui-block="button-019"]{color-scheme:dark}
