...
--vibeui-toggle-006-accent:light-dark(oklch(0.287 0 0),oklch(0.905 0 0));
--vibeui-toggle-006-soft:light-dark(oklch(0.95 0 0),oklch(0.3 0 0));
--vibeui-toggle-006-strong:light-dark(oklch(0.24 0 0),oklch(0.928 0 0));
