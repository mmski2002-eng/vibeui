...
--vibeui-button-062-accent:light-dark(oklch(0.295 0 0),oklch(0.906 0 0));
...
opacity:0;translate:-100% 0;color:oklch(from var(--vibeui-button-062-accent) clamp(0,(0.62 - l) * 100,1) 0 0);}
