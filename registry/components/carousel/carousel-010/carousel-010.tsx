...
--vibeui-carousel-010-accent:light-dark(oklch(0.287 0 0),oklch(0.888 0 0));
...
background:var(--vibeui-carousel-010-accent);color:oklch(from var(--vibeui-carousel-010-accent) clamp(0,(0.62 - l) * 100,1) 0 0);
