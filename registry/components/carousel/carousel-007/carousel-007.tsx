...
--vibeui-carousel-007-bg:light-dark(oklch(1 0 0),oklch(0.21 0 265));
--vibeui-carousel-007-fg:light-dark(oklch(0.22 0 265),oklch(0.94 0 265));
--vibeui-carousel-007-muted:color-mix(in oklab,var(--vibeui-carousel-007-fg) 68%,transparent);
--vibeui-carousel-007-border:light-dark(oklch(0.91 0 265),oklch(0.36 0 265));
