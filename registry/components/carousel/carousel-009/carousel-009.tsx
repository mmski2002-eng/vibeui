...
--vibeui-carousel-009-accent:light-dark(oklch(0.287 0 0),oklch(0.903 0 0));
...
width:1.125rem;background:var(--vibeui-carousel-009-accent);color:oklch(from var(--vibeui-carousel-009-accent) clamp(0,(0.62 - l) * 100,1) 0 0);}
