...
--vibeui-carousel-016-accent:light-dark(oklch(0.287 0 0),oklch(0.903 0 0));
...
transition:width .28s ease;color:oklch(from var(--vibeui-carousel-016-accent) clamp(0,(0.62 - l) * 100,1) 0 0);}
