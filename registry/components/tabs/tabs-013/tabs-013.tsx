...
--vibeui-tabs-013-accent:light-dark(oklch(0.275 0 0),oklch(0.91 0 0));
...
animation:vibeui-tabs-013-pulse 1s ease-in-out infinite;color:oklch(from var(--vibeui-tabs-013-accent) clamp(0,(0.62 - l) * 100,1) 0 0);}
