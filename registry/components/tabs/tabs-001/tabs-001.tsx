...
--vibeui-tabs-001-accent:light-dark(oklch(0.287 0 0),oklch(0.899 0 0));
...
transition:transform .18s cubic-bezier(.32,.72,0,1);color:oklch(from var(--vibeui-tabs-001-accent) clamp(0,(0.62 - l) * 100,1) 0 0);}
