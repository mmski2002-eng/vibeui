...
--vibeui-empty-011-accent:light-dark(oklch(0.24 0.015 265),oklch(0.93 0.006 265));
...
background:var(--vibeui-empty-011-accent);color:oklch(from var(--vibeui-empty-011-accent) clamp(0,(0.62 - l) * 100,1) 0 0);
