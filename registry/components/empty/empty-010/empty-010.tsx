...
--vibeui-empty-010-fg:light-dark(oklch(0.21 0 265),oklch(0.95 0 265));
--vibeui-empty-010-muted:color-mix(in oklab,var(--vibeui-empty-010-fg) 68%,transparent);
--vibeui-empty-010-border:light-dark(oklch(0.9 0 265),oklch(0.37 0 265));
--vibeui-empty-010-hover:light-dark(oklch(0.97 0 265),oklch(0.31 0 265));
--vibeui-empty-010-accent:light-dark(oklch(0.24 0.015 265),oklch(0.93 0.006 265));
--vibeui-empty-010-accent-fg:light-dark(oklch(0.99 0 265),oklch(0.18 0 265));
