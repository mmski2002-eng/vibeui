...
--vibeui-empty-016-fg:light-dark(oklch(0.21 0 265),oklch(0.94 0 265));
--vibeui-empty-016-muted:color-mix(in oklab,var(--vibeui-empty-016-fg) 68%,transparent);
--vibeui-empty-016-border:light-dark(oklch(0.91 0 265),oklch(0.34 0 265));
--vibeui-empty-016-accent:light-dark(oklch(0.24 0.015 265),oklch(0.93 0.006 265));
--vibeui-empty-016-on-accent:light-dark(oklch(0.99 0 265),oklch(0.17 0.01 265));
...
background:var(--vibeui-empty-016-accent);color:oklch(from var(--vibeui-empty-016-accent) clamp(0,(0.62 - l) * 100,1) 0 0);
