...
--vibeui-empty-014-accent:light-dark(oklch(0.24 0.015 265),oklch(0.93 0.006 265));
--vibeui-empty-014-on-accent:light-dark(oklch(0.99 0 265),oklch(0.17 0.01 265));
...
background:var(--vibeui-empty-014-accent);color:oklch(from var(--vibeui-empty-014-accent) clamp(0,(0.62 - l) * 100,1) 0 0);
