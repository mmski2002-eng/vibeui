...
--vibeui-range-007-accent:light-dark(oklch(0.55 0.18 39.8),oklch(0.79 0.14 39.8));
--vibeui-range-007-soft:light-dark(oklch(0.55 0.18 39.8 / 12%),oklch(0.79 0.14 39.8 / 20%));
