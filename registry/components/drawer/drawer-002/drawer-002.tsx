...
--vibeui-drawer-002-accent:light-dark(oklch(0.55 0.17 39.8),oklch(0.73 0.15 39.8));
...
:where(.dark,[data-theme="dark"]) [data-vibeui-block="drawer-002"]{color-scheme:dark}
...
[data-vibeui-block="drawer-002"]:has(dialog:not(:modal)[open]){
display:block;position:relative;width:100%;min-height:24rem;
}
[data-vibeui-block="drawer-002"] dialog:not(:modal){position:absolute;max-width:100%;max-height:100%;z-index:1}
[data-vibeui-block="drawer-002"]:has(dialog:not(:modal)[open]) [data-part="trigger"]{display:none}
