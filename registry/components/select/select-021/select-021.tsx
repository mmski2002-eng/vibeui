...
export type Select021Props = Omit<ComponentProps<"div">, "children"> & {
  label?: string
  name?: string
...
--vibeui-select-021-surface-border:light-dark(oklch(0.91 0 265),oklch(0.34 0 265));
--vibeui-select-021-fg:light-dark(oklch(0.23 0 265),oklch(0.94 0 265));
--vibeui-select-021-muted:color-mix(in oklab,var(--vibeui-select-021-fg) 68%,transparent);
--vibeui-select-021-field:light-dark(oklch(0.985 0 265),oklch(0.27 0 265));
--vibeui-select-021-border:light-dark(oklch(0.87 0 265),oklch(0.42 0 265));
--vibeui-select-021-accent:light-dark(oklch(0.55 0.19 39.8),oklch(0.73 0.17 39.8));
...
:where(.dark,[data-theme="dark"]) [data-vibeui-block="select-021"]{color-scheme:dark}
...
[data-vibeui-block="select-021"] select,
[data-vibeui-block="select-021"] option,
[data-vibeui-block="select-021"] optgroup{
background-color:var(--vibeui-select-021-field);color:var(--vibeui-select-021-fg);
}
