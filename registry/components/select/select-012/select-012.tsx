...
--vibeui-select-012-surface:oklch(1 0 0);
--vibeui-select-012-surface-border:oklch(0.91 0.006 265);
--vibeui-select-012-fg:oklch(0.23 0.016 265);
--vibeui-select-012-muted:oklch(0.55 0.014 265);
--vibeui-select-012-border:oklch(0.87 0.008 265);
--vibeui-select-012-accent:oklch(0.55 0.19 262);
...
border:1px solid var(--vibeui-select-012-surface-border);border-radius:0.875rem;
