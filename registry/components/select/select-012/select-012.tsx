...
--vibeui-select-012-fg:light-dark(oklch(0.23 0 265),oklch(0.94 0 265));
--vibeui-select-012-muted:color-mix(in oklab,var(--vibeui-select-012-fg) 68%,transparent);
--vibeui-select-012-border:light-dark(oklch(0.87 0 265),oklch(0.42 0 265));
--vibeui-select-012-accent:light-dark(oklch(0.55 0.19 39.8),oklch(0.75 0.15 39.8));
...
:where(.dark,[data-theme="dark"]) [data-vibeui-block="select-012"]{color-scheme:dark}
...
[data-vibeui-block="select-012"] select,
[data-vibeui-block="select-012"] option,
[data-vibeui-block="select-012"] optgroup{
background-color:light-dark(oklch(1 0 0),oklch(0.24 0.01 265));color:var(--vibeui-select-012-fg);
}
