...
export type Select025Props = Omit<ComponentProps<"div">, "children"> & {
...
--vibeui-select-025-accent:light-dark(oklch(0.55 0.19 39.8),oklch(0.73 0.17 39.8));
...
:where(.dark,[data-theme="dark"]) [data-vibeui-block="select-025"]{color-scheme:dark}
...
[data-vibeui-block="select-025"] select,
[data-vibeui-block="select-025"] option,
[data-vibeui-block="select-025"] optgroup{
background-color:var(--vibeui-select-025-field);color:var(--vibeui-select-025-fg);
}
