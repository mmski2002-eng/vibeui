...
// валидации. Это постоянная памятка, а не реакция на выбор.
const STYLES = `
:where([data-vibeui-block="select-023"]){
--vibeui-select-023-surface:transparent;
--vibeui-select-023-surface-border:light-dark(oklch(0.91 0 265),oklch(0.34 0 265));
--vibeui-select-023-fg:light-dark(oklch(0.23 0 265),oklch(0.94 0 265));
--vibeui-select-023-muted:color-mix(in oklab,var(--vibeui-select-023-fg) 68%,transparent);
--vibeui-select-023-field:light-dark(oklch(0.985 0 265),oklch(0.27 0 265));
--vibeui-select-023-border:light-dark(oklch(0.87 0 265),oklch(0.42 0 265));
--vibeui-select-023-accent:light-dark(oklch(0.55 0.19 39.8),oklch(0.73 0.17 39.8));
...
:where(.dark,[data-theme="dark"]) [data-vibeui-block="select-023"]{color-scheme:dark}
...
[data-vibeui-block="select-023"] select,
[data-vibeui-block="select-023"] option,
[data-vibeui-block="select-023"] optgroup{
background-color:var(--vibeui-select-023-field);color:var(--vibeui-select-023-fg);
}
...
export function Select023({
  ...
  const palette = {
    ...
    ...(background
      ? {
          "--vibeui-select-023-surface": background,
