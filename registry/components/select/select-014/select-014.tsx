...
--vibeui-select-014-accent:light-dark(oklch(0.55 0.19 39.8),oklch(0.73 0.17 39.8));
--vibeui-select-014-tint:light-dark(oklch(0.55 0.19 39.8 / 12%),oklch(0.73 0.17 39.8 / 20%));
