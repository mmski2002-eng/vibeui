...
--vibeui-select-003-accent:light-dark(oklch(0.58 0.16 39.8),oklch(0.76 0.14 39.8));
--vibeui-select-003-tint:light-dark(oklch(0.58 0.16 39.8 / 12%),oklch(0.76 0.14 39.8 / 20%));
