...
--vibeui-select-017-surface-border:light-dark(oklch(0.91 0 265),oklch(0.34 0 265));
--vibeui-select-017-fg:light-dark(oklch(0.23 0 265),oklch(0.94 0 265));
--vibeui-select-017-muted:color-mix(in oklab,var(--vibeui-select-017-fg) 68%,transparent);
--vibeui-select-017-field:light-dark(oklch(0.985 0 265),oklch(0.27 0 265));
--vibeui-select-017-border:light-dark(oklch(0.87 0 265),oklch(0.42 0 265));
--vibeui-select-017-accent:light-dark(oklch(0.55 0.19 39.8),oklch(0.74 0.15 39.8));
...
[data-vibeui-block="select-017"] select,
[data-vibeui-block="select-017"] option,
[data-vibeui-block="select-017"] optgroup{
background-color:var(--vibeui-select-017-field);color:var(--vibeui-select-017-fg);
}
