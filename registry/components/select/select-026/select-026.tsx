...
--vibeui-select-026-accent:light-dark(oklch(0.287 0 0),oklch(0.901 0 0));
--vibeui-select-026-warn:light-dark(oklch(0.68 0.15 75),oklch(0.8 0.15 78));
...
:where(.dark,[data-theme="dark"]) [data-vibeui-block="select-026"]{color-scheme:dark}
...
[data-vibeui-block="select-026"] select,
[data-vibeui-block="select-026"] option,
[data-vibeui-block="select-026"] optgroup{
background-color:var(--vibeui-select-026-field);color:var(--vibeui-select-026-fg);
}
