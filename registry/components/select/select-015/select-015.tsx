...
--vibeui-select-015-surface-border:light-dark(oklch(0.91 0 265),oklch(0.34 0 265));
...
--vibeui-select-015-accent:light-dark(oklch(0.287 0 0),oklch(0.901 0 0));
--vibeui-select-015-tint:light-dark(oklch(0.287 0 0 / 12%),oklch(0.901 0 0 / 20%));
