...
--vibeui-select-010-accent:light-dark(oklch(0.55 0.19 39.8),oklch(0.75 0.15 39.8));
--vibeui-select-010-tint:light-dark(oklch(0.55 0.19 39.8 / 12%),oklch(0.75 0.15 39.8 / 20%));
