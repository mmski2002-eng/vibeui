...
--vibeui-select-028-accent:light-dark(oklch(0.287 0 0),oklch(0.901 0 0));
--vibeui-select-028-tone-low:light-dark(oklch(0.62 0.13 200),oklch(0.78 0.12 200));
--vibeui-select-028-tone-medium:light-dark(oklch(0.7 0.15 75),oklch(0.8 0.14 78));
--vibeui-select-028-tone-high:light-dark(oklch(0.58 0.2 25),oklch(0.72 0.19 25));
...
[data-vibeui-block="select-028"] select,
[data-vibeui-block="select-028"] option,
[data-vibeui-block="select-028"] optgroup{
background-color:light-dark(oklch(1 0 0),oklch(0.24 0.01 265));color:var(--vibeui-select-028-fg);
}
