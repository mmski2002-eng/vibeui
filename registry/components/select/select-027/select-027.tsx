...
--vibeui-select-027-surface-border:light-dark(oklch(0.91 0 265),oklch(0.34 0 265));
--vibeui-select-027-fg:light-dark(oklch(0.22 0 265),oklch(0.94 0 265));
--vibeui-select-027-muted:color-mix(in oklab,var(--vibeui-select-027-fg) 68%,transparent);
--vibeui-select-027-field:light-dark(oklch(0.985 0 265),oklch(0.27 0 265));
--vibeui-select-027-border:light-dark(oklch(0.87 0 265),oklch(0.42 0 265));
--vibeui-select-027-accent:light-dark(oklch(0.55 0.19 39.8),oklch(0.73 0.17 39.8));
...
[data-vibeui-block="select-027"] select,
[data-vibeui-block="select-027"] option,
[data-vibeui-block="select-027"] optgroup{
background-color:var(--vibeui-select-027-field);color:var(--vibeui-select-027-fg);
}
