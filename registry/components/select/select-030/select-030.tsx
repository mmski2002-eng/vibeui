...
--vibeui-select-030-surface:oklch(1 0 0);
--vibeui-select-030-surface-border:oklch(0.91 0.006 265);
--vibeui-select-030-fg:oklch(0.22 0.014 265);
--vibeui-select-030-muted:oklch(0.55 0.014 265);
--vibeui-select-030-field:oklch(0.985 0.002 265);
--vibeui-select-030-border:oklch(0.87 0.008 265);
--vibeui-select-030-accent:oklch(0.55 0.19 262);
