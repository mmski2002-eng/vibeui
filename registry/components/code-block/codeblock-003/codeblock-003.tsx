...
--vibeui-codeblock-003-accent:light-dark(oklch(0.5 0.11 39.8),oklch(0.78 0.13 39.8));
--vibeui-codeblock-003-flag:light-dark(oklch(0.53 0.1 39.8),oklch(0.8 0.12 39.8));
