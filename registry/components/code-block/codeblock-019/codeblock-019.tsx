...
--vibeui-codeblock-019-accent:light-dark(oklch(0.5 0.13 39.8),oklch(0.82 0.13 39.8));
--vibeui-codeblock-019-target:light-dark(oklch(0.7 0.12 39.8 / 24%),oklch(0.6 0.12 39.8 / 22%));
