...
--vibeui-radio-018-fg:light-dark(oklch(0.22 0.014 265),oklch(0.94 0.006 265));
--vibeui-radio-018-muted:color-mix(in oklab,var(--vibeui-radio-018-fg) 68%,transparent);
--vibeui-radio-018-border:light-dark(oklch(0.9 0.006 265),oklch(0.37 0.012 265));
...
--vibeui-radio-018-on-accent:oklch(0.99 0.01 265);
