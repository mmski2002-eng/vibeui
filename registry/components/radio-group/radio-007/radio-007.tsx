...
--vibeui-radio-007-accent:light-dark(oklch(0.24 0.015 265),oklch(0.93 0.006 265));
--vibeui-radio-007-free:light-dark(oklch(0.5 0.15 155),oklch(0.76 0.14 155));
--vibeui-radio-007-tint:light-dark(oklch(0.24 0.015 265 / 6%),oklch(0.93 0.006 265 / 12%));
...
:where(.dark,[data-theme="dark"]) [data-vibeui-block="radio-007"]{color-scheme:dark}
