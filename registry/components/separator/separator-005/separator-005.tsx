...
--vibeui-separator-005-disc:light-dark(oklch(0.94 0 0),oklch(0.31 0 0));
--vibeui-separator-005-line:light-dark(oklch(0.85 0 0),oklch(0.854 0 0));
--vibeui-separator-005-fg:light-dark(oklch(0.263 0 0),oklch(0.923 0 0));
}
