...
--vibeui-textarea-005-accent:light-dark(oklch(0.55 0.19 39.8),oklch(0.75 0.15 39.8));
--vibeui-textarea-005-tint:light-dark(oklch(0.55 0.19 39.8 / 10%),oklch(0.75 0.15 39.8 / 20%));
