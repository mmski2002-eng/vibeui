...
--vibeui-filters-009-box:light-dark(oklch(1 0 0),oklch(0.27 0 265));
--vibeui-filters-009-fill:light-dark(oklch(0.975 0 265),oklch(0.3 0 265));
--vibeui-filters-009-fg:light-dark(oklch(0.23 0 265),oklch(0.94 0 265));
--vibeui-filters-009-muted:color-mix(in oklab,var(--vibeui-filters-009-fg) 68%,transparent);
--vibeui-filters-009-border:light-dark(oklch(0.89 0 265),oklch(0.4 0 265));
--vibeui-filters-009-shell:light-dark(oklch(0.91 0 265),oklch(0.36 0 265));
--vibeui-filters-009-accent:light-dark(oklch(0.275 0 0),oklch(0.906 0 0));
...
background:var(--vibeui-filters-009-accent);border-color:var(--vibeui-filters-009-accent);color:oklch(from var(--vibeui-filters-009-accent) clamp(0,(0.62 - l) * 100,1) 0 0);}
...
background:var(--vibeui-filters-009-accent);color:oklch(from var(--vibeui-filters-009-accent) clamp(0,(0.62 - l) * 100,1) 0 0);
