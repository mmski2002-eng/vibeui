...
--vibeui-cascader-020-accent:light-dark(oklch(0.53 0.14 39.8),oklch(0.75 0.14 39.8));
--vibeui-cascader-020-accentsoft:light-dark(oklch(0.95 0.04 39.8),oklch(0.33 0.05 39.8));
