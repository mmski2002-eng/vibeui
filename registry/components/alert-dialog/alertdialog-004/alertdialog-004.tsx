...
--vibeui-alertdialog-004-bg:light-dark(oklch(1 0 0),oklch(0.22 0 265));
--vibeui-alertdialog-004-fg:light-dark(oklch(0.22 0 265),oklch(0.94 0 265));
--vibeui-alertdialog-004-muted:color-mix(in oklab,var(--vibeui-alertdialog-004-fg) 68%,transparent);
--vibeui-alertdialog-004-border:light-dark(oklch(0.9 0 265),oklch(0.36 0 265));
...
--vibeui-alertdialog-004-track:light-dark(oklch(0.93 0 265),oklch(0.32 0 265));
--vibeui-alertdialog-004-shadow:light-dark(oklch(0.2 0 265 / 55%),oklch(0.02 0 265 / 70%));
...
[data-vibeui-block="alertdialog-004"] dialog::backdrop{background:light-dark(oklch(0.2 0 265 / 45%),oklch(0.08 0 265 / 62%))}
