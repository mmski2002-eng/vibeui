...
--vibeui-alertdialog-007-bg:light-dark(oklch(1 0 0),oklch(0.22 0 265));
--vibeui-alertdialog-007-panel:light-dark(oklch(0.97 0 265),oklch(0.27 0 265));
...
:where(.dark,[data-theme="dark"]) [data-vibeui-block="alertdialog-007"]{color-scheme:dark}
...
[data-vibeui-block="alertdialog-007"] dialog::backdrop{background:light-dark(oklch(0.2 0 265 / 45%),oklch(0.08 0 265 / 62%))}
...
html:has([data-vibeui-block="alertdialog-007"] dialog[open]:modal){overflow:hidden}
...
[data-vibeui-block="alertdialog-007"]:has(dialog:not(:modal)[open]){
display:block;position:relative;width:100%;min-height:22rem;
}
[data-vibeui-block="alertdialog-007"] dialog:not(:modal){position:absolute;max-width:100%;max-height:100%;z-index:1}
[data-vibeui-block="alertdialog-007"]:has(dialog:not(:modal)[open]) [data-part="open"]{display:none}
