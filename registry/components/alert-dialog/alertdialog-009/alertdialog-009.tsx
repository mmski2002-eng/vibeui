...
--vibeui-alertdialog-009-accent:light-dark(oklch(0.287 0 0),oklch(0.899 0 0));
--vibeui-alertdialog-009-badge-bg:light-dark(oklch(0.287 0 0 / 12%),oklch(0.899 0 0 / 18%));
