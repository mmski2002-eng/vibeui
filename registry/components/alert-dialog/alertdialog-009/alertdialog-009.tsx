...
--vibeui-alertdialog-009-accent:light-dark(oklch(0.55 0.2 39.8),oklch(0.72 0.18 39.8));
--vibeui-alertdialog-009-badge-bg:light-dark(oklch(0.55 0.2 39.8 / 12%),oklch(0.72 0.18 39.8 / 18%));
