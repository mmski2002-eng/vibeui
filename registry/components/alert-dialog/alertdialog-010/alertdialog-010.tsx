...
--vibeui-alertdialog-010-bg:light-dark(oklch(1 0 0),oklch(0.22 0 265));
--vibeui-alertdialog-010-panel:light-dark(oklch(0.97 0 265),oklch(0.27 0 265));
...
--vibeui-alertdialog-010-accent:light-dark(oklch(0.287 0 0),oklch(0.899 0 0));
...
--vibeui-alertdialog-010-keep:light-dark(oklch(0.28 0 0),oklch(0.906 0 0));
--vibeui-alertdialog-010-when-bg:light-dark(oklch(0.287 0 0 / 8%),oklch(0.899 0 0 / 14%));
...
[data-vibeui-block="alertdialog-010"] dialog::backdrop{background:light-dark(oklch(0.2 0 265 / 45%),oklch(0.08 0 265 / 62%))}
...
[data-vibeui-block="alertdialog-010"] [data-part="confirm"]{border:0;background:var(--vibeui-alertdialog-010-accent);color:oklch(from var(--vibeui-alertdialog-010-accent) clamp(0,(0.62 - l) * 100,1) 0 0);}
...
html:has([data-vibeui-block="alertdialog-010"] dialog[open]:modal){overflow:hidden}
...
[data-vibeui-block="alertdialog-010"]:has(dialog:not(:modal)[open]){
display:block;position:relative;width:100%;min-height:26rem;
}
[data-vibeui-block="alertdialog-010"] dialog:not(:modal){position:absolute;max-width:100%;max-height:100%;z-index:1}
[data-vibeui-block="alertdialog-010"]:has(dialog:not(:modal)[open]) [data-part="open"]{display:none}
