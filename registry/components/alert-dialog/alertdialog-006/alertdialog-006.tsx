...
--vibeui-alertdialog-006-accent:light-dark(oklch(0.287 0 0),oklch(0.899 0 0));
...
[data-vibeui-block="alertdialog-006"] [data-part="confirm"]{border:0;background:var(--vibeui-alertdialog-006-accent);color:oklch(from var(--vibeui-alertdialog-006-accent) clamp(0,(0.62 - l) * 100,1) 0 0);}
