...
--vibeui-number-005-accent:light-dark(oklch(0.5 0.14 39.8),oklch(0.72 0.12 39.8));
--vibeui-number-005-ring:light-dark(oklch(0.5 0.14 39.8 / 20%),oklch(0.72 0.12 39.8 / 30%));
