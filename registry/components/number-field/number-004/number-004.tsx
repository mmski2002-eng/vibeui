...
--vibeui-number-004-accent:light-dark(oklch(0.58 0.17 39.8),oklch(0.76 0.15 39.8));
--vibeui-number-004-ring:light-dark(oklch(0.58 0.17 39.8 / 20%),oklch(0.76 0.15 39.8 / 30%));
