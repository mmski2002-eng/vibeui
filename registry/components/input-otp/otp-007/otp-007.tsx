...
--vibeui-otp-007-accent:light-dark(oklch(0.275 0 0),oklch(0.903 0 0));
...
animation:vibeui-otp-007-run 1.1s ease-in-out infinite;color:oklch(from var(--vibeui-otp-007-accent) clamp(0,(0.62 - l) * 100,1) 0 0);}
