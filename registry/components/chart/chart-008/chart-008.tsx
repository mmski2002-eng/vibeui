...
--vibeui-chart-008-accent:light-dark(oklch(0.55 0.17 39.8),oklch(0.74 0.15 39.8));
--vibeui-chart-008-drop:light-dark(oklch(0.58 0.16 39.8),oklch(0.75 0.14 39.8));
