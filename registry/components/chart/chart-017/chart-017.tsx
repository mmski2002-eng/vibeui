...
--vibeui-chart-017-accent:light-dark(oklch(0.55 0.17 39.8),oklch(0.62 0.17 39.8));
        ...
        <ol>
          {steps.map((step, index) => {
            ...
            const edges = {
              ...
              "--vibeui-chart-017-slab": `color-mix(in oklab,var(--vibeui-chart-017-accent) ${100 - index * 13}%,oklch(0.72 0.05 39.8))`,
            } as CSSProperties
