...
--vibeui-inputgroup-028-accent:light-dark(oklch(0.56 0.14 39.8),oklch(0.77 0.13 39.8));
...
:where(.dark,[data-theme="dark"]) [data-vibeui-block="inputgroup-028"]{color-scheme:dark}
