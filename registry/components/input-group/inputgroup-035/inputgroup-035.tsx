...
--vibeui-inputgroup-035-accent:light-dark(oklch(0.287 0 0),oklch(0.908 0 0));
--vibeui-inputgroup-035-available:light-dark(oklch(0.29 0 0),oklch(0.912 0 0));
--vibeui-inputgroup-035-taken:light-dark(oklch(0.29 0 0),oklch(0.905 0 0));
