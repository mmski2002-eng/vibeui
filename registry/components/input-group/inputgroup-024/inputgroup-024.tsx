...
--vibeui-inputgroup-024-accent:light-dark(oklch(0.275 0 0),oklch(0.901 0 0));
--vibeui-inputgroup-024-checking:light-dark(oklch(0.6 0 265),oklch(0.72 0 265));
--vibeui-inputgroup-024-accepted:light-dark(oklch(0.29 0 0),oklch(0.906 0 0));
--vibeui-inputgroup-024-rejected:light-dark(oklch(0.29 0 0),oklch(0.899 0 0));
