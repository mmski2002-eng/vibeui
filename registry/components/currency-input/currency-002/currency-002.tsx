...
--vibeui-currency-002-field:light-dark(oklch(0.985 0 265),oklch(0.26 0 265));
--vibeui-currency-002-chip:light-dark(oklch(1 0 0),oklch(0.31 0 265));
--vibeui-currency-002-shell:light-dark(oklch(0.9 0 265),oklch(0.34 0 265));
--vibeui-currency-002-fg:light-dark(oklch(0.22 0 265),oklch(0.94 0 265));
--vibeui-currency-002-muted:color-mix(in oklab,var(--vibeui-currency-002-fg) 68%,transparent);
--vibeui-currency-002-border:light-dark(oklch(0.88 0 265),oklch(0.38 0 265));
--vibeui-currency-002-accent:light-dark(oklch(0.52 0.16 39.8),oklch(0.72 0.14 39.8));
...
:where(.dark,[data-theme="dark"]) [data-vibeui-block="currency-002"]{color-scheme:dark}
