...
--vibeui-field-011-accent:light-dark(oklch(0.287 0 0),oklch(0.903 0 0));
...
animation:vibeui-field-011-pulse 0.9s ease-in-out infinite;color:oklch(from var(--vibeui-field-011-accent) clamp(0,(0.62 - l) * 100,1) 0 0);}
