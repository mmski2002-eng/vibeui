...
--vibeui-toggle-004-accent:light-dark(oklch(0.58 0.15 39.8),oklch(0.76 0.12 39.8));
--vibeui-toggle-004-line:light-dark(oklch(0.58 0.15 39.8 / 26%),oklch(0.76 0.12 39.8 / 34%));
