...
--vibeui-toggle-009-accent:light-dark(oklch(0.307 0 0),oklch(0.899 0 0));
...
background:color-mix(in oklab,var(--vibeui-toggle-009-fg) 14%,var(--vibeui-toggle-009-bg));color:var(--vibeui-toggle-009-fg);
