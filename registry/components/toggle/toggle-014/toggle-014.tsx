...
--vibeui-toggle-014-accent:light-dark(oklch(0.68 0.17 39.8),oklch(0.79 0.15 39.8));
--vibeui-toggle-014-soft:light-dark(oklch(0.96 0.03 55),oklch(0.31 0.045 39.8));
