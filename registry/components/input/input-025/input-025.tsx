...
--vibeui-input-025-shell:light-dark(oklch(0.91 0 265),oklch(0.34 0 265));
--vibeui-input-025-fg:light-dark(oklch(0.22 0 265),oklch(0.94 0 265));
--vibeui-input-025-muted:color-mix(in oklab,var(--vibeui-input-025-fg) 68%,transparent);
--vibeui-input-025-field:light-dark(oklch(0.985 0 265),oklch(0.26 0 265));
--vibeui-input-025-border:light-dark(oklch(0.88 0 265),oklch(0.38 0 265));
--vibeui-input-025-chip:light-dark(oklch(0.95 0 265),oklch(0.3 0 265));
--vibeui-input-025-accent:light-dark(oklch(0.5 0.14 39.8),oklch(0.72 0.13 39.8));
...
:where(.dark,[data-theme="dark"]) [data-vibeui-block="input-025"]{color-scheme:dark}
