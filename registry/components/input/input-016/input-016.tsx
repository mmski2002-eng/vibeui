...
--vibeui-input-016-muted:light-dark(oklch(0.56 0.014 265),oklch(0.7 0.012 265));
...
background:var(--vibeui-input-016-accent);border-color:var(--vibeui-input-016-accent);color:var(--vibeui-input-016-on-accent);
}
