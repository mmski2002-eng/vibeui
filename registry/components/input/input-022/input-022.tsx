...
--vibeui-input-022-accent:light-dark(oklch(0.287 0 0),oklch(0.903 0 0));
--vibeui-input-022-on-accent:light-dark(oklch(1 0 0),oklch(0.2 0 0));
...
background:var(--vibeui-input-022-accent);color:oklch(from var(--vibeui-input-022-accent) clamp(0,(0.62 - l) * 100,1) 0 0);
}
