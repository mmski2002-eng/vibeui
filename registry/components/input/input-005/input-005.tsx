...
--vibeui-input-005-fg:light-dark(oklch(0.22 0 265),oklch(0.94 0 265));
--vibeui-input-005-muted:color-mix(in oklab,var(--vibeui-input-005-fg) 68%,transparent);
--vibeui-input-005-border:light-dark(oklch(0.9 0 265),oklch(0.4 0 265));
--vibeui-input-005-field:light-dark(oklch(0.985 0 265),oklch(0.26 0 265));
--vibeui-input-005-accent:light-dark(oklch(0.55 0.17 39.8),oklch(0.74 0.15 39.8));
