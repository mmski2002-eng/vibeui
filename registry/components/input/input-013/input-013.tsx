...
--vibeui-input-013-accent:light-dark(oklch(0.275 0 0),oklch(0.899 0 0));
...
background:var(--vibeui-input-013-accent);color:oklch(from var(--vibeui-input-013-accent) clamp(0,(0.62 - l) * 100,1) 0 0);
