...
--vibeui-kanban-005-muted:color-mix(in oklab,var(--vibeui-kanban-005-fg) 68%,transparent);
...
:where(.dark,[data-theme="dark"]) [data-vibeui-block="kanban-005"]{color-scheme:dark}
