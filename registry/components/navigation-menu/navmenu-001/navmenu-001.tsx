...
--vibeui-navmenu-001-bg:light-dark(oklch(1 0 0),oklch(0.23 0 265));
--vibeui-navmenu-001-fg:light-dark(oklch(0.22 0 265),oklch(0.94 0 265));
--vibeui-navmenu-001-muted:color-mix(in oklab,var(--vibeui-navmenu-001-fg) 68%,transparent);
--vibeui-navmenu-001-border:light-dark(oklch(0.91 0 265),oklch(0.36 0 265));
--vibeui-navmenu-001-hover:light-dark(oklch(0.55 0 265 / 8%),oklch(0.85 0 265 / 12%));
--vibeui-navmenu-001-accent:light-dark(oklch(0.55 0.2 39.8),oklch(0.74 0.16 39.8));
--vibeui-navmenu-001-shadow:light-dark(oklch(0.2 0 265 / 40%),oklch(0 0 0 / 70%));
...
:where(.dark,[data-theme="dark"]) [data-vibeui-block="navmenu-001"]{color-scheme:dark}
...
[data-vibeui-block="navmenu-001"] [aria-current="page"]{
font-weight:700;
