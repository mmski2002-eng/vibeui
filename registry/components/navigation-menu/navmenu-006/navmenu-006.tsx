...
--vibeui-navmenu-006-accent:light-dark(oklch(0.55 0.2 39.8),oklch(0.74 0.16 39.8));
...
background:var(--vibeui-navmenu-006-accent);color:var(--vibeui-navmenu-006-on-accent);
