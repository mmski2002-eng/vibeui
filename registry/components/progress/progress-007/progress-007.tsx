...
--vibeui-progress-007-accent:light-dark(oklch(0.3 0 0),oklch(0.899 0 0));
...
animation:vibeui-progress-007-pulse 1.6s ease-in-out infinite;color:oklch(from var(--vibeui-progress-007-accent) clamp(0,(0.62 - l) * 100,1) 0 0);}
