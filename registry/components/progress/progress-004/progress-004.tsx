...
--vibeui-progress-004-accent:light-dark(oklch(0.284 0 0),oklch(0.899 0 0));
--vibeui-progress-004-tile:light-dark(oklch(0.95 0 262),oklch(0.32 0 0));
...
transition:width .3s cubic-bezier(.32,.72,0,1);color:oklch(from var(--vibeui-progress-004-accent) clamp(0,(0.62 - l) * 100,1) 0 0);}
