...
--vibeui-toast-025-accent:light-dark(oklch(0.55 0.15 39.8),oklch(0.72 0.14 39.8));
...
background:var(--vibeui-toast-025-accent);color:var(--vibeui-toast-025-on-accent);
