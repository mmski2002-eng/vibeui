...
export type Toast021Props = Omit<ComponentProps<"div">, "children"> & {
  message?: string
  tone?: Toast021Tone
  glyph?: string
  closeLabel?: string
...
--vibeui-toast-021-tone:light-dark(oklch(0.58 0.16 39.8),oklch(0.6 0.15 39.8));
...
:where(.dark,[data-theme="dark"]) [data-vibeui-block="toast-021"]{color-scheme:dark}
