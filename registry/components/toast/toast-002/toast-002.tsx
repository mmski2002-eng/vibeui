...
--vibeui-toast-002-accent:light-dark(oklch(0.275 0 0),oklch(0.91 0 0));
...
transition:width .2s linear;color:oklch(from var(--vibeui-toast-002-accent) clamp(0,(0.62 - l) * 100,1) 0 0);}
