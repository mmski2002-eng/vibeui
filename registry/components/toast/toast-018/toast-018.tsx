...
--vibeui-toast-018-bg:oklch(0.99 0.002 265);
--vibeui-toast-018-fg:oklch(0.22 0.014 265);
--vibeui-toast-018-muted:oklch(0.56 0.014 265);
--vibeui-toast-018-border:oklch(0.9 0.006 265);
--vibeui-toast-018-accent:oklch(0.58 0.16 260);
...
background:var(--vibeui-toast-018-accent);color:oklch(0.99 0.004 265);
...
[data-vibeui-block="toast-018"] [data-part="row"] button:hover{background:oklch(0 0 0 / 6%);color:var(--vibeui-toast-018-fg)}
  ...
  return (
    <>
      ...
      >
        ...
        {list.length === 0 ? (
          <p data-part="empty">Событий больше нет</p>
        ) : (
          <>
            ...
            {hidden > 0 || expanded ? (
              ...
              >
                {expanded ? collapseLabel : `${expandLabel} · ещё ${hidden}`}
              </button>
            ) : null}
          </>
        )}
