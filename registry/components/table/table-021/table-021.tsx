...
--vibeui-table-021-fg:light-dark(oklch(0.24 0 265),oklch(0.93 0 265));
--vibeui-table-021-muted:color-mix(in oklab,var(--vibeui-table-021-fg) 68%,transparent);
--vibeui-table-021-border:light-dark(oklch(0.92 0 265),oklch(0.36 0 265));
--vibeui-table-021-head:light-dark(oklch(0.5 0 265 / 5%),oklch(0.85 0 265 / 7%));
--vibeui-table-021-accent:light-dark(oklch(0.55 0.2 39.8),oklch(0.75 0.16 39.8));
