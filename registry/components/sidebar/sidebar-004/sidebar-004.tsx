...
--vibeui-sidebar-004-fg:light-dark(oklch(0.25 0 265),oklch(0.93 0 265));
--vibeui-sidebar-004-muted:color-mix(in oklab,var(--vibeui-sidebar-004-fg) 68%,transparent);
--vibeui-sidebar-004-border:light-dark(oklch(0.91 0 265),oklch(0.35 0 265));
--vibeui-sidebar-004-hover:light-dark(oklch(0.55 0 265 / 7%),oklch(0.85 0 265 / 10%));
--vibeui-sidebar-004-accent:light-dark(oklch(0.54 0.16 39.8),oklch(0.74 0.14 39.8));
