...
export const CATEGORIES = [
  ...
  { slug: "codeblock", label: "Code Block", group: "application" },
  { slug: "combobox", label: "Combobox", group: "application" },
  { slug: "label", label: "Label", group: "application" },
  { slug: "nativeselect", label: "Native Select", group: "application" },
  { slug: "phoneinput", label: "Phone Input", group: "application" },
  { slug: "resizable", label: "Resizable", group: "application" },
  { slug: "toggle", label: "Toggle", group: "application" },
  { slug: "togglegroup", label: "Toggle Group", group: "application" },
  { slug: "eventcalendar", label: "Event Calendar", group: "application" },
  { slug: "menu", label: "Menu", group: "navigation" },
