...
[data-vibeui-block="vet-004"] [data-part="stage"]{position:relative;width:min(100%,24rem);aspect-ratio:1;margin:1.8rem 0 0;container-type:inline-size;border-radius:2rem;background:color-mix(in oklab,var(--vibeui-vet-004-fg) 4%,transparent);border:1px solid var(--vibeui-vet-004-line);overflow:hidden}
