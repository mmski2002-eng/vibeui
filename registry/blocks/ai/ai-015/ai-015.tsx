...
--vibeui-ai-015-accent:light-dark(oklch(0.52 0.17 39.8),oklch(0.74 0.14 39.8));
--vibeui-ai-015-on-accent:oklch(0.15 0.02 39.8);
...
:where(.dark,[data-theme="dark"]) [data-vibeui-block="ai-015"]{color-scheme:dark}
