...
import { Card073 } from "@/registry/components/card/card-073/card-073"
...
[data-vibeui-block="layout-015"] [data-part="side"] [data-vibeui-block="card-073"]{background:none;border:0;padding:0;min-height:0;justify-content:flex-start;overflow:visible}
[data-vibeui-block="layout-015"] [data-part="side"] [data-vibeui-block="card-073"]::before,[data-vibeui-block="layout-015"] [data-part="side"] [data-vibeui-block="card-073"]::after{display:none}
[data-vibeui-block="layout-015"] [data-part="side"] [data-vibeui-block="card-073"]:hover{transform:none}
...
[data-vibeui-block="layout-015"] [data-part="scroll"] > [data-vibeui-block="card-073"]{flex:none;min-height:16rem}
[data-vibeui-block="layout-015"] [data-part="scroll"] > [data-vibeui-block="card-073"] [data-part="image"]{min-height:12rem}
[data-vibeui-block="layout-015"] [data-part="scroll"] > [data-vibeui-block="card-073"]:nth-child(2){min-height:12rem}
...
export function Layout015({
  ...
  const tile = (area: (typeof SLOTS)[number], className?: string, key?: string) => (
    <Card073 key={key ?? area} data-part="tile" {...items?.[SLOTS.indexOf(area)]} numbers={numbers} index={SLOTS.indexOf(area)} ghost={GHOST[area]} data-area={area} className={className} accent={accent} />
  )
