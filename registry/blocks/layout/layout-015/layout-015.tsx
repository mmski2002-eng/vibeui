...
--vibeui-layout-015-dur-4:340ms;
--vibeui-layout-015-dur-5:460ms;
...
[data-vibeui-block="layout-015"] [data-part="tile-num"]{position:absolute;top:1.125rem;left:1.125rem;z-index:1;font:500 0.6875rem/1 var(--vibeui-layout-015-mono);letter-spacing:0.08em;padding:0.375rem 0.5rem;border-radius:999px;color:var(--vibeui-layout-015-muted);border:1px solid var(--vibeui-layout-015-edge);background:color-mix(in oklab,var(--vibeui-layout-015-tile) 70%,transparent);transition:color var(--vibeui-layout-015-dur-4),border-color var(--vibeui-layout-015-dur-4),background-color var(--vibeui-layout-015-dur-4)}
[data-vibeui-block="layout-015"][data-numbers] [data-part="icon"],[data-vibeui-block="layout-015"][data-numbers] [data-part="faces"],[data-vibeui-block="layout-015"][data-numbers] [data-part="spark"],[data-vibeui-block="layout-015"][data-numbers] [data-part="window"]{margin-top:2rem}
...
[data-vibeui-block="layout-015"] [data-part="side"] [data-part="tile-num"]{position:static;align-self:flex-start}
...
[data-vibeui-block="layout-015"] [data-part="tile"]{position:relative;overflow:hidden;min-height:10rem;padding:1.5rem;border-radius:var(--vibeui-layout-015-radius);
...
[data-vibeui-block="layout-015"] [data-part="tile"] [data-part="value"]{font-size:clamp(2.5rem,6cqi,3.5rem);font-weight:650;letter-spacing:-0.03em;line-height:1}
[data-vibeui-block="layout-015"] [data-part="tile"] [data-part="media"]{position:absolute;inset:0;pointer-events:none}
[data-vibeui-block="layout-015"] [data-part="tile"] [data-part="media"] > *{width:100%;height:100%;object-fit:cover;display:block}
[data-vibeui-block="layout-015"] [data-part="tile"] > :not([data-part="media"]):not([data-part="num"]){position:relative}
[data-vibeui-block="layout-015"] [data-part="tile"] [data-part="num"]{position:absolute;top:1.125rem;left:1.125rem;z-index:1;font:500 0.6875rem/1 var(--vibeui-layout-015-mono);letter-spacing:0.08em;padding:0.375rem 0.5rem;border-radius:999px;color:var(--vibeui-layout-015-muted);border:1px solid var(--vibeui-layout-015-edge);background:color-mix(in oklab,var(--vibeui-layout-015-tile) 70%,transparent);transition:color var(--vibeui-layout-015-dur-4),border-color var(--vibeui-layout-015-dur-4),background-color var(--vibeui-layout-015-dur-4)}
...
[data-vibeui-block="layout-015"] [data-part="tile"][data-numbers] [data-part="rows"],[data-vibeui-block="layout-015"] [data-part="tile"][data-numbers] [data-part="image"]{margin-top:2rem}
[data-vibeui-block="layout-015"] [data-part="tile"] [data-part="bar"]{display:block;height:0.875rem;border-radius:999px;background:var(--vibeui-layout-015-ghost-strong);width:70%}
[data-vibeui-block="layout-015"] [data-part="tile"] [data-part="bar"][data-soft]{background:var(--vibeui-layout-015-ghost);height:0.625rem;width:50%}
[data-vibeui-block="layout-015"] [data-part="tile"] [data-part="bar"][data-wide]{width:88%}
[data-vibeui-block="layout-015"] [data-part="tile"] [data-part="bar"][data-big]{height:1.5rem}
[data-vibeui-block="layout-015"] [data-part="tile"] [data-part="rows"]{display:flex;flex-direction:column;gap:1rem;flex:1;justify-content:space-evenly;padding-block:0.5rem}
[data-vibeui-block="layout-015"] [data-part="tile"] [data-part="rows"] span{display:flex;align-items:center;gap:0.75rem}
[data-vibeui-block="layout-015"] [data-part="tile"] [data-part="rows"] i{width:0.75rem;height:0.75rem;border-radius:999px;background:var(--vibeui-layout-015-accent);flex:none;transition:transform var(--vibeui-layout-015-dur-5) cubic-bezier(.2,.8,.2,1)}
[data-vibeui-block="layout-015"] [data-part="tile"] [data-part="rows"] b{display:block;height:0.625rem;border-radius:999px;background:var(--vibeui-layout-015-ghost);flex:1}
[data-vibeui-block="layout-015"] [data-part="tile"] [data-part="rows"] span:nth-child(odd) b{max-width:80%}
[data-vibeui-block="layout-015"] [data-part="tile"] [data-part="rows"][data-table] span{gap:1.25rem;padding:0.5rem 0;border-bottom:1px solid var(--vibeui-layout-015-edge)}
[data-vibeui-block="layout-015"] [data-part="tile"] [data-part="rows"][data-table] b:first-child{max-width:30%}
...
export function Layout015({
  ...
  function handleMove(event: PointerEvent<HTMLDivElement>) {
    ...
    frame.current = requestAnimationFrame(() => {
      target.style.setProperty("--vibeui-card-073-mx", `${x}%`)
      target.style.setProperty("--vibeui-card-073-my", `${y}%`)
      target.style.setProperty("--vibeui-card-073-on", "1")
    })
  }
  ...
  function handleLeave(event: PointerEvent<HTMLDivElement>) {
    ...
    target?.style.setProperty("--vibeui-card-073-on", "0")
  }
            ...
            <aside data-part="side">
              {items?.[0]?.title || items?.[0]?.text ? (
                <div data-part="tile" data-area="about">
                  {numbers ? <span data-part="tile-num" aria-hidden="true">01</span> : null}
