...
[data-vibeui-block="layout-008"] [data-part="tile"]{
position:relative;overflow:hidden;min-height:10rem;padding:1.5rem;border-radius:var(--vibeui-layout-008-radius);
...
[data-vibeui-block="layout-008"] [data-part="value"]{font-size:clamp(2.5rem,6cqi,3.5rem);font-weight:650;letter-spacing:-0.03em;line-height:1}
[data-vibeui-block="layout-008"] [data-part="media"]{position:absolute;inset:0;pointer-events:none}
[data-vibeui-block="layout-008"] [data-part="media"] > *{width:100%;height:100%;object-fit:cover;display:block}
[data-vibeui-block="layout-008"] [data-part="tile"] > :not([data-part="media"]):not([data-part="num"]){position:relative}
[data-vibeui-block="layout-008"] [data-part="num"]{position:absolute;top:1.125rem;left:1.125rem;z-index:1;font:500 0.6875rem/1 var(--vibeui-layout-008-mono);letter-spacing:0.08em;padding:0.375rem 0.5rem;border-radius:999px;color:var(--vibeui-layout-008-muted);border:1px solid var(--vibeui-layout-008-edge);background:color-mix(in oklab,var(--vibeui-layout-008-tile) 70%,transparent);transition:color var(--vibeui-layout-008-dur-4),border-color var(--vibeui-layout-008-dur-4),background-color var(--vibeui-layout-008-dur-4)}
...
[data-vibeui-block="layout-008"][data-numbers] [data-part="icon"],[data-vibeui-block="layout-008"][data-numbers] [data-part="faces"],[data-vibeui-block="layout-008"][data-numbers] [data-part="spark"],[data-vibeui-block="layout-008"][data-numbers] [data-part="rows"],[data-vibeui-block="layout-008"][data-numbers] [data-part="image"],[data-vibeui-block="layout-008"][data-numbers] [data-part="window"]{margin-top:2rem}
/* Призраки. */
[data-vibeui-block="layout-008"] [data-part="bar"]{display:block;height:0.875rem;border-radius:999px;background:var(--vibeui-layout-008-ghost-strong);width:70%}
[data-vibeui-block="layout-008"] [data-part="bar"][data-soft]{background:var(--vibeui-layout-008-ghost);height:0.625rem;width:50%}
[data-vibeui-block="layout-008"] [data-part="bar"][data-wide]{width:88%}
[data-vibeui-block="layout-008"] [data-part="bar"][data-big]{height:1.5rem}
...
[data-vibeui-block="layout-008"] [data-part="tile"]:hover [data-part="button"]{transform:translateX(4px)}
[data-vibeui-block="layout-008"] [data-part="big"]{display:block;height:3rem;width:55%;border-radius:0.75rem;background:var(--vibeui-layout-008-ghost-strong)}
[data-vibeui-block="layout-008"] [data-part="rows"]{display:flex;flex-direction:column;gap:1rem;flex:1;justify-content:space-evenly;padding-block:0.5rem}
[data-vibeui-block="layout-008"] [data-part="rows"] span{display:flex;align-items:center;gap:0.75rem}
[data-vibeui-block="layout-008"] [data-part="rows"] i{width:0.75rem;height:0.75rem;border-radius:999px;background:var(--vibeui-layout-008-accent);flex:none;transition:transform var(--vibeui-layout-008-dur-5) cubic-bezier(.2,.8,.2,1)}
[data-vibeui-block="layout-008"] [data-part="rows"] b{display:block;height:0.625rem;border-radius:999px;background:var(--vibeui-layout-008-ghost);flex:1}
[data-vibeui-block="layout-008"] [data-part="rows"] span:nth-child(odd) b{max-width:80%}
[data-vibeui-block="layout-008"] [data-part="rows"][data-table] span{gap:1.25rem;padding:0.5rem 0;border-bottom:1px solid var(--vibeui-layout-008-edge)}
[data-vibeui-block="layout-008"] [data-part="rows"][data-table] b:first-child{max-width:30%}
...
[data-vibeui-block="layout-008"] [data-part="tile"]:hover [data-part="icon"]{transform:rotate(-6deg) scale(1.08)}
...
[data-vibeui-block="layout-008"] [data-part="tile"]:hover [data-part="faces"] i:nth-child(2){transform:translateX(3px)}
[data-vibeui-block="layout-008"] [data-part="tile"]:hover [data-part="faces"] i:nth-child(3){transform:translateX(6px)}
[data-vibeui-block="layout-008"] [data-part="tile"]:hover [data-part="faces"] i:nth-child(4){transform:translateX(9px)}
[data-vibeui-block="layout-008"] [data-part="spark"]{width:100%;height:4rem;margin-bottom:auto;overflow:visible}
[data-vibeui-block="layout-008"] [data-part="spark"] path{fill:none;stroke:var(--vibeui-layout-008-accent);stroke-width:2.5;stroke-linecap:round;stroke-linejoin:round;stroke-dasharray:240;stroke-dashoffset:0}
[data-vibeui-block="layout-008"] [data-part="spark"] path[data-fill]{fill:var(--vibeui-layout-008-glow);fill-opacity:0.25;stroke:none}
...
[data-vibeui-block="layout-008"] [data-part="tile"]:hover [data-part="image"]{transform:scale(1.02)}
...
[data-vibeui-block="layout-008"] [data-part="side"] [data-part="num"]{position:static;align-self:flex-start}
...
[data-vibeui-block="layout-008"] [data-part="side"] [data-part="rows"]{justify-content:flex-start;gap:0.5rem}
[data-vibeui-block="layout-008"] [data-part="side"] [data-part="rows"] span{padding:0.5rem 0.625rem;border-radius:0.5rem}
[data-vibeui-block="layout-008"] [data-part="side"] [data-part="rows"] span:first-child{background:color-mix(in oklab,var(--vibeui-layout-008-accent) 12%,transparent)}
[data-vibeui-block="layout-008"] [data-part="side"] [data-part="rows"] i{border-radius:0.25rem;width:1rem;height:1rem;background:var(--vibeui-layout-008-ghost-strong)}
[data-vibeui-block="layout-008"] [data-part="side"] [data-part="rows"] span:first-child i{background:var(--vibeui-layout-008-accent)}
...
[data-vibeui-block="layout-008"] [data-part="top"] [data-part="bar"]{height:0.625rem;width:8rem;margin:0}
...
[data-vibeui-block="layout-008"] [data-area="table"] [data-part="rows"]{margin-top:0}
[data-vibeui-block="layout-008"][data-numbers] [data-area="table"] [data-part="rows"]{margin-top:2rem}
...
[data-vibeui-block="layout-008"] [data-part="toggle"]:checked ~ [data-part="side"] [data-part="brand"] b,[data-vibeui-block="layout-008"] [data-part="toggle"]:checked ~ [data-part="side"] [data-part="rows"] b,[data-vibeui-block="layout-008"] [data-part="toggle"]:checked ~ [data-part="side"] [data-part="bar"],[data-vibeui-block="layout-008"] [data-part="toggle"]:checked ~ [data-part="side"] h3,[data-vibeui-block="layout-008"] [data-part="toggle"]:checked ~ [data-part="side"] p{display:none}
...
function Tile({ area, item, numbers, index, className }: TileProps) {
  ...
  return (
    <article
      ...
      style={{ "--vibeui-layout-008-i": index } as CSSProperties}
    >
...
export function Layout008({
  ...
  function handleMove(event: PointerEvent<HTMLDivElement>) {
    ...
    frame.current = requestAnimationFrame(() => {
      target.style.setProperty("--vibeui-layout-008-mx", `${x}%`)
      target.style.setProperty("--vibeui-layout-008-my", `${y}%`)
      target.style.setProperty("--vibeui-layout-008-on", "1")
    })
  }
  ...
  function handleLeave(event: PointerEvent<HTMLDivElement>) {
    ...
    target?.style.setProperty("--vibeui-layout-008-on", "0")
  }
        ...
        <div data-part="frame">
          ...
          <div data-part="body" onPointerMove={handleMove} onPointerOut={handleLeave}>
            ...
            <header data-part="top">
              ...
              {items?.[1]?.title ? <h3>{items[1].title}</h3> : <span data-part="bar" aria-hidden="true" />}
