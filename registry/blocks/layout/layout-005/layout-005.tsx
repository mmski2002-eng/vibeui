...
[data-vibeui-block="layout-005"] [data-part="tile"]{
position:relative;overflow:hidden;min-height:10rem;padding:1.5rem;border-radius:var(--vibeui-layout-005-radius);
...
[data-vibeui-block="layout-005"] [data-part="value"]{font-size:clamp(2.5rem,6cqi,3.5rem);font-weight:650;letter-spacing:-0.03em;line-height:1}
[data-vibeui-block="layout-005"] [data-part="media"]{position:absolute;inset:0;pointer-events:none}
[data-vibeui-block="layout-005"] [data-part="media"] > *{width:100%;height:100%;object-fit:cover;display:block}
[data-vibeui-block="layout-005"] [data-part="tile"] > :not([data-part="media"]):not([data-part="num"]){position:relative}
[data-vibeui-block="layout-005"] [data-part="num"]{position:absolute;top:1.125rem;left:1.125rem;z-index:1;font:500 0.6875rem/1 var(--vibeui-layout-005-mono);letter-spacing:0.08em;padding:0.375rem 0.5rem;border-radius:999px;color:var(--vibeui-layout-005-muted);border:1px solid var(--vibeui-layout-005-edge);background:color-mix(in oklab,var(--vibeui-layout-005-tile) 70%,transparent);transition:color var(--vibeui-layout-005-dur-4),border-color var(--vibeui-layout-005-dur-4),background-color var(--vibeui-layout-005-dur-4)}
...
[data-vibeui-block="layout-005"][data-numbers] [data-part="icon"],[data-vibeui-block="layout-005"][data-numbers] [data-part="faces"],[data-vibeui-block="layout-005"][data-numbers] [data-part="spark"],[data-vibeui-block="layout-005"][data-numbers] [data-part="rows"],[data-vibeui-block="layout-005"][data-numbers] [data-part="image"],[data-vibeui-block="layout-005"][data-numbers] [data-part="window"]{margin-top:2rem}
/* Призраки. */
[data-vibeui-block="layout-005"] [data-part="bar"]{display:block;height:0.875rem;border-radius:999px;background:var(--vibeui-layout-005-ghost-strong);width:70%}
[data-vibeui-block="layout-005"] [data-part="bar"][data-soft]{background:var(--vibeui-layout-005-ghost);height:0.625rem;width:50%}
[data-vibeui-block="layout-005"] [data-part="bar"][data-wide]{width:88%}
[data-vibeui-block="layout-005"] [data-part="bar"][data-big]{height:1.5rem}
[data-vibeui-block="layout-005"] [data-part="button"]{display:inline-block;width:6.5rem;height:2.5rem;border-radius:0.75rem;background:var(--vibeui-layout-005-accent);margin-top:0.5rem;transition:transform var(--vibeui-layout-005-dur-5) cubic-bezier(.2,.8,.2,1)}
...
[data-vibeui-block="layout-005"] [data-part="tile"]:hover [data-part="rows"] i{transform:scale(1.35)}
...
[data-vibeui-block="layout-005"] [data-part="tile"]:hover [data-part="icon"]{transform:rotate(-6deg) scale(1.08)}
[data-vibeui-block="layout-005"] [data-part="faces"]{display:flex;margin-bottom:auto}
[data-vibeui-block="layout-005"] [data-part="faces"] i{width:2.5rem;height:2.5rem;border-radius:999px;border:2px solid var(--vibeui-layout-005-tile);background:var(--vibeui-layout-005-ghost-strong);margin-inline-start:-0.625rem;transition:transform var(--vibeui-layout-005-dur-5) cubic-bezier(.2,.8,.2,1)}
[data-vibeui-block="layout-005"] [data-part="faces"] i:first-child{margin-inline-start:0;background:var(--vibeui-layout-005-accent)}
...
[data-vibeui-block="layout-005"] [data-part="spark"]{width:100%;height:4rem;margin-bottom:auto;overflow:visible}
[data-vibeui-block="layout-005"] [data-part="spark"] path{fill:none;stroke:var(--vibeui-layout-005-accent);stroke-width:2.5;stroke-linecap:round;stroke-linejoin:round;stroke-dasharray:240;stroke-dashoffset:0}
[data-vibeui-block="layout-005"] [data-part="spark"] path[data-fill]{fill:var(--vibeui-layout-005-glow);fill-opacity:0.25;stroke:none}
...
function Tile({ area, item, numbers, index, className }: TileProps) {
  ...
  return (
    <article
      ...
      style={{ "--vibeui-layout-005-i": index } as CSSProperties}
    >
...
export function Layout005({
  ...
  function handleMove(event: PointerEvent<HTMLDivElement>) {
    ...
    frame.current = requestAnimationFrame(() => {
      target.style.setProperty("--vibeui-layout-005-mx", `${x}%`)
      target.style.setProperty("--vibeui-layout-005-my", `${y}%`)
      target.style.setProperty("--vibeui-layout-005-on", "1")
    })
  }
  ...
  function handleLeave(event: PointerEvent<HTMLDivElement>) {
    ...
    target?.style.setProperty("--vibeui-layout-005-on", "0")
  }
