...
[data-vibeui-block="layout-012"] [data-part="tile"]{
position:relative;overflow:hidden;min-height:10rem;padding:1.5rem;border-radius:var(--vibeui-layout-012-radius);
...
[data-vibeui-block="layout-012"] [data-part="value"]{font-size:clamp(2.5rem,6cqi,3.5rem);font-weight:650;letter-spacing:-0.03em;line-height:1}
[data-vibeui-block="layout-012"] [data-part="media"]{position:absolute;inset:0;pointer-events:none}
[data-vibeui-block="layout-012"] [data-part="media"] > *{width:100%;height:100%;object-fit:cover;display:block}
[data-vibeui-block="layout-012"] [data-part="tile"] > :not([data-part="media"]):not([data-part="num"]){position:relative}
[data-vibeui-block="layout-012"] [data-part="num"]{position:absolute;top:1.125rem;left:1.125rem;z-index:1;font:500 0.6875rem/1 var(--vibeui-layout-012-mono);letter-spacing:0.08em;padding:0.375rem 0.5rem;border-radius:999px;color:var(--vibeui-layout-012-muted);border:1px solid var(--vibeui-layout-012-edge);background:color-mix(in oklab,var(--vibeui-layout-012-tile) 70%,transparent);transition:color var(--vibeui-layout-012-dur-4),border-color var(--vibeui-layout-012-dur-4),background-color var(--vibeui-layout-012-dur-4)}
...
[data-vibeui-block="layout-012"][data-numbers] [data-part="icon"],[data-vibeui-block="layout-012"][data-numbers] [data-part="faces"],[data-vibeui-block="layout-012"][data-numbers] [data-part="spark"],[data-vibeui-block="layout-012"][data-numbers] [data-part="rows"],[data-vibeui-block="layout-012"][data-numbers] [data-part="image"],[data-vibeui-block="layout-012"][data-numbers] [data-part="window"]{margin-top:2rem}
/* Призраки. */
[data-vibeui-block="layout-012"] [data-part="bar"]{display:block;height:0.875rem;border-radius:999px;background:var(--vibeui-layout-012-ghost-strong);width:70%}
[data-vibeui-block="layout-012"] [data-part="bar"][data-soft]{background:var(--vibeui-layout-012-ghost);height:0.625rem;width:50%}
[data-vibeui-block="layout-012"] [data-part="bar"][data-wide]{width:88%}
[data-vibeui-block="layout-012"] [data-part="bar"][data-big]{height:1.5rem}
...
[data-vibeui-block="layout-012"] [data-part="tile"]:hover [data-part="button"]{transform:translateX(4px)}
...
[data-vibeui-block="layout-012"] [data-part="tile"]:hover [data-part="rows"] i{transform:scale(1.35)}
[data-vibeui-block="layout-012"] [data-part="icon"]{width:2.75rem;height:2.75rem;border-radius:0.875rem;background:var(--vibeui-layout-012-accent);margin-bottom:auto;transition:transform var(--vibeui-layout-012-dur-5) cubic-bezier(.2,.8,.2,1)}
...
[data-vibeui-block="layout-012"] [data-part="tile"]:hover [data-part="faces"] i:nth-child(2){transform:translateX(3px)}
[data-vibeui-block="layout-012"] [data-part="tile"]:hover [data-part="faces"] i:nth-child(3){transform:translateX(6px)}
[data-vibeui-block="layout-012"] [data-part="tile"]:hover [data-part="faces"] i:nth-child(4){transform:translateX(9px)}
...
[data-vibeui-block="layout-012"] [data-part="tile"]:hover [data-part="spark"] path:not([data-fill]){animation:vibeui-layout-012-draw 1.1s cubic-bezier(.2,.8,.2,1)}
...
[data-vibeui-block="layout-012"] [data-part="tile"]:hover [data-part="image"]{transform:scale(1.02)}
...
[data-vibeui-block="layout-012"] [data-part="node"] [data-part="icon"]{margin:0;width:2rem;height:2rem;border-radius:0.625rem}
[data-vibeui-block="layout-012"] [data-part="node"] [data-part="bar"],[data-vibeui-block="layout-012"] [data-part="node"] p{display:none}
[data-vibeui-block="layout-012"] [data-part="node"] h3{font-size:0.75rem;text-align:center;padding:0 0.25rem}
[data-vibeui-block="layout-012"] [data-part="node"] [data-part="num"]{top:0.25rem;left:auto;right:0.25rem;padding:0.25rem 0.375rem;font-size:0.5625rem}
[data-vibeui-block="layout-012"] [data-area="core"] [data-part="num"]{top:0.5rem;left:0.5rem}
...
[data-vibeui-block="layout-012"] [data-area="core"] [data-part="icon"]{margin:0;width:3rem;height:3rem;border-radius:1rem}
[data-vibeui-block="layout-012"] [data-area="core"] [data-part="bar"],[data-vibeui-block="layout-012"] [data-area="core"] p{display:none}
...
function Tile({ area, item, numbers, index, className }: TileProps) {
  ...
  return (
    <article
      ...
      style={{ "--vibeui-layout-012-i": index } as CSSProperties}
    >
...
export function Layout012({
  ...
  function handleMove(event: PointerEvent<HTMLDivElement>) {
    ...
    frame.current = requestAnimationFrame(() => {
      target.style.setProperty("--vibeui-layout-012-mx", `${x}%`)
      target.style.setProperty("--vibeui-layout-012-my", `${y}%`)
      target.style.setProperty("--vibeui-layout-012-on", "1")
    })
  }
  ...
  function handleLeave(event: PointerEvent<HTMLDivElement>) {
    ...
    target?.style.setProperty("--vibeui-layout-012-on", "0")
  }
