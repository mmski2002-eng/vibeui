...
[data-vibeui-block="layout-003"] [data-part="tile"]{
position:relative;overflow:hidden;min-height:10rem;padding:1.5rem;border-radius:var(--vibeui-layout-003-radius);
...
[data-vibeui-block="layout-003"] [data-part="value"]{font-size:clamp(2.5rem,6cqi,3.5rem);font-weight:650;letter-spacing:-0.03em;line-height:1}
[data-vibeui-block="layout-003"] [data-part="media"]{position:absolute;inset:0;pointer-events:none}
[data-vibeui-block="layout-003"] [data-part="media"] > *{width:100%;height:100%;object-fit:cover;display:block}
[data-vibeui-block="layout-003"] [data-part="tile"] > :not([data-part="media"]):not([data-part="num"]){position:relative}
[data-vibeui-block="layout-003"] [data-part="num"]{position:absolute;top:1.125rem;left:1.125rem;z-index:1;font:500 0.6875rem/1 var(--vibeui-layout-003-mono);letter-spacing:0.08em;padding:0.375rem 0.5rem;border-radius:999px;color:var(--vibeui-layout-003-muted);border:1px solid var(--vibeui-layout-003-edge);background:color-mix(in oklab,var(--vibeui-layout-003-tile) 70%,transparent);transition:color var(--vibeui-layout-003-dur-4),border-color var(--vibeui-layout-003-dur-4),background-color var(--vibeui-layout-003-dur-4)}
...
[data-vibeui-block="layout-003"][data-numbers] [data-part="icon"],[data-vibeui-block="layout-003"][data-numbers] [data-part="faces"],[data-vibeui-block="layout-003"][data-numbers] [data-part="spark"],[data-vibeui-block="layout-003"][data-numbers] [data-part="rows"],[data-vibeui-block="layout-003"][data-numbers] [data-part="image"],[data-vibeui-block="layout-003"][data-numbers] [data-part="window"]{margin-top:2rem}
/* Призраки. */
[data-vibeui-block="layout-003"] [data-part="bar"]{display:block;height:0.875rem;border-radius:999px;background:var(--vibeui-layout-003-ghost-strong);width:70%}
[data-vibeui-block="layout-003"] [data-part="bar"][data-soft]{background:var(--vibeui-layout-003-ghost);height:0.625rem;width:50%}
[data-vibeui-block="layout-003"] [data-part="bar"][data-wide]{width:88%}
[data-vibeui-block="layout-003"] [data-part="bar"][data-big]{height:1.5rem}
...
[data-vibeui-block="layout-003"] [data-part="tile"]:hover [data-part="button"]{transform:translateX(4px)}
...
[data-vibeui-block="layout-003"] [data-part="tile"]:hover [data-part="rows"] i{transform:scale(1.35)}
...
[data-vibeui-block="layout-003"] [data-part="tile"]:hover [data-part="icon"]{transform:rotate(-6deg) scale(1.08)}
...
[data-vibeui-block="layout-003"] [data-part="tile"]:hover [data-part="faces"] i:nth-child(2){transform:translateX(3px)}
[data-vibeui-block="layout-003"] [data-part="tile"]:hover [data-part="faces"] i:nth-child(3){transform:translateX(6px)}
[data-vibeui-block="layout-003"] [data-part="tile"]:hover [data-part="faces"] i:nth-child(4){transform:translateX(9px)}
...
[data-vibeui-block="layout-003"][data-rules] [data-part="tile"]{border-top:1px solid var(--vibeui-layout-003-edge-hover)}
[data-vibeui-block="layout-003"] [data-part="num"]{position:static;order:-1;align-self:flex-start;border:0;background:none;padding:0 0 0.5rem;font-size:0.75rem;color:var(--vibeui-layout-003-muted)}
[data-vibeui-block="layout-003"] [data-part="tile"]:hover [data-part="num"]{background:none;color:var(--vibeui-layout-003-accent)}
[data-vibeui-block="layout-003"][data-numbers] [data-part="image"]{margin-top:0}
[data-vibeui-block="layout-003"] [data-area="lead"]{min-height:22rem;gap:1rem}
[data-vibeui-block="layout-003"] [data-area="lead"] [data-part="image"]{min-height:16rem;flex:none;border-radius:0.5rem}
[data-vibeui-block="layout-003"] [data-area="lead"] h3{font-size:clamp(1.5rem,3cqi,2.25rem);line-height:1.1;letter-spacing:-0.02em}
[data-vibeui-block="layout-003"] [data-area="lead"] [data-part="bar"]{height:1.5rem}
...
function Tile({ area, item, numbers, index, className }: TileProps) {
  ...
  return (
    <article
      ...
      style={{ "--vibeui-layout-003-i": index } as CSSProperties}
    >
...
export function Layout003({
  ...
  function handleMove(event: PointerEvent<HTMLDivElement>) {
    ...
    frame.current = requestAnimationFrame(() => {
      target.style.setProperty("--vibeui-layout-003-mx", `${x}%`)
      target.style.setProperty("--vibeui-layout-003-my", `${y}%`)
      target.style.setProperty("--vibeui-layout-003-on", "1")
    })
  }
  ...
  function handleLeave(event: PointerEvent<HTMLDivElement>) {
    ...
    target?.style.setProperty("--vibeui-layout-003-on", "0")
  }
