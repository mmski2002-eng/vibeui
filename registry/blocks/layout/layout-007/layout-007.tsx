...
[data-vibeui-block="layout-007"] [data-part="tile"]{
position:relative;overflow:hidden;min-height:10rem;padding:1.5rem;border-radius:var(--vibeui-layout-007-radius);
background:var(--vibeui-layout-007-tile);border:1px solid var(--vibeui-layout-007-edge);
display:flex;flex-direction:column;justify-content:flex-end;gap:0.75rem;
--vibeui-layout-007-mx:50%;--vibeui-layout-007-my:50%;--vibeui-layout-007-on:0;
transition:transform var(--vibeui-layout-007-dur-5) cubic-bezier(.2,.8,.2,1),border-color var(--vibeui-layout-007-dur-5);
}
[data-vibeui-block="layout-007"] [data-part="tile"]::before{content:"";position:absolute;inset:0;pointer-events:none;border-radius:inherit;background:radial-gradient(22rem circle at var(--vibeui-layout-007-mx) var(--vibeui-layout-007-my),color-mix(in oklab,var(--vibeui-layout-007-accent) 14%,transparent),transparent 60%);opacity:var(--vibeui-layout-007-on);transition:opacity var(--vibeui-layout-007-dur-5)}
[data-vibeui-block="layout-007"] [data-part="tile"]::after{content:"";position:absolute;inset:-1px;pointer-events:none;border-radius:inherit;padding:1px;background:radial-gradient(18rem circle at var(--vibeui-layout-007-mx) var(--vibeui-layout-007-my),color-mix(in oklab,var(--vibeui-layout-007-accent) 70%,transparent),transparent 55%);-webkit-mask:linear-gradient(#000 0 0) content-box,linear-gradient(#000 0 0);mask:linear-gradient(#000 0 0) content-box,linear-gradient(#000 0 0);-webkit-mask-composite:xor;mask-composite:exclude;opacity:var(--vibeui-layout-007-on);transition:opacity var(--vibeui-layout-007-dur-5)}
[data-vibeui-block="layout-007"] [data-part="tile"]:hover{border-color:var(--vibeui-layout-007-edge-hover)}
[data-vibeui-block="layout-007"] [data-part="tile"] h3{margin:0;font-size:1.125rem;font-weight:600;line-height:1.3}
[data-vibeui-block="layout-007"] [data-part="tile"] p{margin:0;color:var(--vibeui-layout-007-muted);font-size:0.9375rem;line-height:1.45}
[data-vibeui-block="layout-007"] [data-part="value"]{font-size:clamp(2.5rem,6cqi,3.5rem);font-weight:650;letter-spacing:-0.03em;line-height:1}
[data-vibeui-block="layout-007"] [data-part="media"]{position:absolute;inset:0;pointer-events:none}
[data-vibeui-block="layout-007"] [data-part="media"] > *{width:100%;height:100%;object-fit:cover;display:block}
[data-vibeui-block="layout-007"] [data-part="tile"] > :not([data-part="media"]):not([data-part="num"]){position:relative}
[data-vibeui-block="layout-007"] [data-part="num"]{position:absolute;top:1.125rem;left:1.125rem;z-index:1;font:500 0.6875rem/1 var(--vibeui-layout-007-mono);letter-spacing:0.08em;padding:0.375rem 0.5rem;border-radius:999px;color:var(--vibeui-layout-007-muted);border:1px solid var(--vibeui-layout-007-edge);background:color-mix(in oklab,var(--vibeui-layout-007-tile) 70%,transparent);transition:color var(--vibeui-layout-007-dur-4),border-color var(--vibeui-layout-007-dur-4),background-color var(--vibeui-layout-007-dur-4)}
[data-vibeui-block="layout-007"] [data-part="tile"]:hover [data-part="num"]{color:var(--vibeui-layout-007-on-accent);background:var(--vibeui-layout-007-accent);border-color:var(--vibeui-layout-007-accent)}
...
/* Призраки. */
[data-vibeui-block="layout-007"] [data-part="bar"]{display:block;height:0.875rem;border-radius:999px;background:var(--vibeui-layout-007-ghost-strong);width:70%}
[data-vibeui-block="layout-007"] [data-part="bar"][data-soft]{background:var(--vibeui-layout-007-ghost);height:0.625rem;width:50%}
[data-vibeui-block="layout-007"] [data-part="bar"][data-wide]{width:88%}
[data-vibeui-block="layout-007"] [data-part="bar"][data-big]{height:1.5rem}
[data-vibeui-block="layout-007"] [data-part="button"]{display:inline-block;width:6.5rem;height:2.5rem;border-radius:0.75rem;background:var(--vibeui-layout-007-accent);margin-top:0.5rem;transition:transform var(--vibeui-layout-007-dur-5) cubic-bezier(.2,.8,.2,1)}
[data-vibeui-block="layout-007"] [data-part="tile"]:hover [data-part="button"]{transform:translateX(4px)}
[data-vibeui-block="layout-007"] [data-part="big"]{display:block;height:3rem;width:55%;border-radius:0.75rem;background:var(--vibeui-layout-007-ghost-strong)}
...
[data-vibeui-block="layout-007"] [data-part="tile"]:hover [data-part="rows"] i{transform:scale(1.35)}
...
[data-vibeui-block="layout-007"] [data-part="tile"]:hover [data-part="icon"]{transform:rotate(-6deg) scale(1.08)}
...
[data-vibeui-block="layout-007"] [data-part="tile"]:hover [data-part="faces"] i:nth-child(2){transform:translateX(3px)}
[data-vibeui-block="layout-007"] [data-part="tile"]:hover [data-part="faces"] i:nth-child(3){transform:translateX(6px)}
[data-vibeui-block="layout-007"] [data-part="tile"]:hover [data-part="faces"] i:nth-child(4){transform:translateX(9px)}
...
[data-vibeui-block="layout-007"] [data-part="tile"]:hover [data-part="spark"] path:not([data-fill]){animation:vibeui-layout-007-draw 1.1s cubic-bezier(.2,.8,.2,1)}
...
[data-vibeui-block="layout-007"] [data-part="tile"]:hover [data-part="image"]{transform:scale(1.02)}
...
[data-vibeui-block="layout-007"] [data-part="tile"]{min-height:9rem;padding:1.25rem;justify-content:flex-start}
[data-vibeui-block="layout-007"][data-numbers] [data-part="tile"]{padding-top:3.25rem}
...
[data-vibeui-block="layout-007"] [data-part="tile"]:hover{transform:none}
[data-vibeui-block="layout-007"] [data-part="tile"]::before,[data-vibeui-block="layout-007"] [data-part="tile"]::after{display:none}
}
`
...
function Tile({ area, item, numbers, index, className }: TileProps) {
  ...
  return (
    <article
      ...
      style={{ "--vibeui-layout-007-i": index } as CSSProperties}
    >
...
export function Layout007({
  ...
  function handleMove(event: PointerEvent<HTMLDivElement>) {
    ...
    frame.current = requestAnimationFrame(() => {
      target.style.setProperty("--vibeui-layout-007-mx", `${x}%`)
      target.style.setProperty("--vibeui-layout-007-my", `${y}%`)
      target.style.setProperty("--vibeui-layout-007-on", "1")
    })
  }
  ...
  function handleLeave(event: PointerEvent<HTMLDivElement>) {
    ...
    target?.style.setProperty("--vibeui-layout-007-on", "0")
  }
