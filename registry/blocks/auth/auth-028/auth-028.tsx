...
--vibeui-auth-028-card:light-dark(oklch(1 0 0),oklch(0.22 0 265));
...
--vibeui-auth-028-badge:light-dark(oklch(0.55 0 265 / 12%),oklch(0.82 0 265 / 14%));
...
:where(.dark,[data-theme="dark"]) [data-vibeui-block="auth-028"]{color-scheme:dark}
