...
--vibeui-auth-024-accent:light-dark(oklch(0.53 0.18 39.8),oklch(0.76 0.14 39.8));
--vibeui-auth-024-on-accent:oklch(0.15 0.02 39.8);
--vibeui-auth-024-tint:light-dark(oklch(0.53 0.18 39.8 / 12%),oklch(0.76 0.14 39.8 / 18%));
--vibeui-auth-024-soft:light-dark(oklch(0.53 0.18 39.8 / 10%),oklch(0.76 0.14 39.8 / 16%));
