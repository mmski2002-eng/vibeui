...
--vibeui-auth-007-bg:oklch(0.97 0.005 265);
--vibeui-auth-007-card:oklch(1 0 0);
--vibeui-auth-007-fg:oklch(0.22 0.014 265);
--vibeui-auth-007-muted:oklch(0.55 0.014 265);
--vibeui-auth-007-border:oklch(0.9 0.006 265);
--vibeui-auth-007-accent:oklch(0.55 0.2 262);
--vibeui-auth-007-danger:oklch(0.55 0.19 25);
--vibeui-auth-007-warn:oklch(0.62 0.15 75);
...
border:1px solid oklch(0.55 0.19 25 / 30%);border-radius:0.625rem;
background:oklch(0.55 0.19 25 / 8%);
...
background:var(--vibeui-auth-007-accent);color:oklch(1 0 0);
        ...
        <div data-part="shell">
          ...
          {failed ? (
            <p data-part="alert" role="alert">
              ...
              <span>
                Почта или пароль не подходят. Проверьте раскладку и попробуйте
                ещё раз.
              </span>
            </p>
          ) : null}
          ...
          >
            <div data-part="field">
              <label htmlFor="vibeui-auth-007-email">Рабочая почта</label>
              <input
              ...
              {emailBad ? (
                <p data-part="hint" id="vibeui-auth-007-email-hint">
                  Похоже на опечатку: адрес выглядит как name@company.ru.
                </p>
              ) : null}
            </div>
            ...
            <div data-part="field">
              <span data-part="row">
                <label htmlFor="vibeui-auth-007-password">Пароль</label>
              ...
              {passwordBad ? (
                <p data-part="hint">Пароль короче восьми знаков.</p>
              ) : null}
              {caps ? (
