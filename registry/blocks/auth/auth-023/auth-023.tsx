...
--vibeui-auth-023-accent:light-dark(oklch(0.55 0.13 39.8),oklch(0.75 0.12 39.8));
--vibeui-auth-023-on-accent:oklch(0.15 0.02 39.8);
...
:where(.dark,[data-theme="dark"]) [data-vibeui-block="auth-023"]{color-scheme:dark}
