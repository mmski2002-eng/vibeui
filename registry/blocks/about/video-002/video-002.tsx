...
const STYLES = `[data-vibeui-block="video-002"] [data-part="heading"]{margin-bottom:1.75rem}
...
transition:border-color var(--vibeui-video-002-dur-2) ease,background-color var(--vibeui-video-002-dur-2) ease;
}
