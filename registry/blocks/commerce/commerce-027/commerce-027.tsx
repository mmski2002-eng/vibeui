...
--vibeui-commerce-027-fg:light-dark(oklch(0.21 0 265),oklch(0.94 0 265));
...
background:oklch(1 0 0);color:oklch(0.22 0 265);font:inherit;font-size:0.9375rem;font-weight:700;
}
