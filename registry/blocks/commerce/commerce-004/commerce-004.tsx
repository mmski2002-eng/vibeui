...
--vibeui-commerce-004-panel:light-dark(oklch(0.985 0 265),oklch(0.26 0 265));
--vibeui-commerce-004-field:light-dark(oklch(1 0 0),oklch(0.22 0 265));
--vibeui-commerce-004-fg:light-dark(oklch(0.22 0 265),oklch(0.94 0 265));
--vibeui-commerce-004-muted:light-dark(oklch(0.55 0 265),oklch(0.71 0 265));
--vibeui-commerce-004-border:light-dark(oklch(0.91 0 265),oklch(0.36 0 265));
--vibeui-commerce-004-accent:light-dark(oklch(0.55 0.2 39.8),oklch(0.72 0.17 39.8));
--vibeui-commerce-004-on-accent:oklch(0.15 0.02 39.8);
--vibeui-commerce-004-pick:light-dark(oklch(0.55 0.2 39.8 / 6%),oklch(0.72 0.17 39.8 / 16%));
...
:where(.dark,[data-theme="dark"]) [data-vibeui-block="commerce-004"]{color-scheme:dark}
