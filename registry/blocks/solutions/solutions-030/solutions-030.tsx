...
--vibeui-solutions-030-accent:light-dark(oklch(0.52 0.16 39.8),oklch(0.74 0.14 39.8));
...
:where(.dark,[data-theme="dark"]) [data-vibeui-block="solutions-030"]{color-scheme:dark}
