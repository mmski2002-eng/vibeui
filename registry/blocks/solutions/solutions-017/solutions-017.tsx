...
--vibeui-solutions-017-accent:light-dark(oklch(0.55 0.14 39.8),oklch(0.74 0.13 39.8));
...
:where(.dark,[data-theme="dark"]) [data-vibeui-block="solutions-017"]{color-scheme:dark}
