...
--vibeui-dashboard-048-bg:oklch(0.985 0.003 200);
--vibeui-dashboard-048-card:oklch(1 0 0);
--vibeui-dashboard-048-fg:oklch(0.22 0.014 200);
--vibeui-dashboard-048-muted:oklch(0.55 0.014 200);
--vibeui-dashboard-048-border:oklch(0.91 0.006 200);
--vibeui-dashboard-048-accent:oklch(0.5 0.13 200);
--vibeui-dashboard-048-soft:oklch(0.96 0.02 200);
--vibeui-dashboard-048-ok:oklch(0.56 0.13 155);
--vibeui-dashboard-048-warn:oklch(0.66 0.15 70);
--vibeui-dashboard-048-bad:oklch(0.58 0.19 25);
--vibeui-dashboard-048-ink:oklch(0.26 0.02 200);
...
border:1px solid color-mix(in oklab,var(--vibeui-dashboard-048-ok) 40%,white);
background:color-mix(in oklab,var(--vibeui-dashboard-048-ok) 10%,white);
}
...
[data-vibeui-block="dashboard-048"] summary:hover{background:var(--vibeui-dashboard-048-bg)}
...
color:oklch(1 0 0);background:var(--vibeui-dashboard-048-ok);
}
...
background:var(--vibeui-dashboard-048-ink);color:oklch(0.93 0.01 200);
}
      ...
      >
        <div data-part="shell">
          <div data-part="head">
            ...
            <p data-part="secret">
              Секрет подписи: <span data-part="mask">{secret}</span>
              <button type="button" data-part="show">
                {secretLabel}
              </button>
            </p>

            <ul data-part="tags" aria-label="Отправляемые события">
              {events.map((event) => (
          ...
          <div data-part="log">
            <p data-part="cap">
              История доставки <span>последние 4 попытки</span>
            </p>
            ...
            {deliveries.map((delivery) => (
              ...
              >
                <summary>
                  <span data-part="code" title={`Код ответа ${delivery.code}`}>
                    {delivery.code}
                  </span>
