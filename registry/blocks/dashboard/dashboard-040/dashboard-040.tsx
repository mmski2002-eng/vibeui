...
--vibeui-dashboard-040-bg:oklch(0.985 0.004 265);
--vibeui-dashboard-040-card:oklch(1 0 0);
--vibeui-dashboard-040-fg:oklch(0.22 0.014 265);
--vibeui-dashboard-040-muted:oklch(0.55 0.014 265);
--vibeui-dashboard-040-border:oklch(0.91 0.006 265);
--vibeui-dashboard-040-accent:oklch(0.48 0.15 285);
--vibeui-dashboard-040-soft:oklch(0.96 0.02 285);
--vibeui-dashboard-040-warn:oklch(0.62 0.16 55);
--vibeui-dashboard-040-done:oklch(0.62 0.012 265);
...
background:var(--vibeui-dashboard-040-accent);color:oklch(1 0 0);
}
...
color:oklch(1 0 0);background:var(--vibeui-dashboard-040-accent);border-color:transparent;
}
...
border-color:color-mix(in oklab,var(--vibeui-dashboard-040-warn) 55%,white);
}
    ...
    <>
      ...
      >
        <div data-part="shell">
          ...
          <nav aria-label="Отбор договоров">
            <ul data-part="chips">
              {filters.map((filter) => (
                <li key={filter}>
                  <a
            ...
            {contracts.map((contract) => (
              <article key={contract.code} data-state={contract.state}>
                <div data-part="top">
                  ...
                  <span data-part="tag">{contract.state}</span>
                </div>
                ...
                <div data-part="term">
                  <div
                    ...
                    aria-valuemin={0}
                    aria-valuemax={100}
                    aria-label={`Срок пройден на ${contract.passed} процентов`}
                  >
                    <span
                      data-part="fill"
                  ...
                  <p data-part="dates">
                    <span>с {contract.start}</span>
                    <span>по {contract.end}</span>
                ...
                <div data-part="foot">
                  ...
                  {contract.auto ? (
                    <span data-part="auto">автопродление включено</span>
                  ) : null}
