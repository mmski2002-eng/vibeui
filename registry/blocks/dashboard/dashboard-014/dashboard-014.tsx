...
--vibeui-dashboard-014-accent:light-dark(oklch(0.55 0.2 39.8),oklch(0.74 0.15 39.8));
...
:where(.dark,[data-theme="dark"]) [data-vibeui-block="dashboard-014"]{color-scheme:dark}
