...
--vibeui-dashboard-067-bg:oklch(0.985 0.003 240);
--vibeui-dashboard-067-card:oklch(1 0 0);
--vibeui-dashboard-067-fg:oklch(0.21 0.014 240);
--vibeui-dashboard-067-muted:oklch(0.55 0.014 240);
--vibeui-dashboard-067-border:oklch(0.91 0.006 240);
--vibeui-dashboard-067-accent:oklch(0.52 0.15 240);
--vibeui-dashboard-067-soft:oklch(0.965 0.02 240);
--vibeui-dashboard-067-done:oklch(0.72 0.07 240);
--vibeui-dashboard-067-risk:oklch(0.6 0.18 30);
--vibeui-dashboard-067-today:oklch(0.45 0.16 300);
...
font-size:0.625rem;font-weight:750;color:oklch(1 0 0);white-space:nowrap;overflow:hidden;
...
background:repeating-linear-gradient(135deg,var(--vibeui-dashboard-067-risk) 0 0.375rem,color-mix(in oklab,var(--vibeui-dashboard-067-risk) 72%,black) 0.375rem 0.75rem);
}
...
content:"сегодня";position:absolute;top:-1.0625rem;left:0.25rem;
...
position:relative;width:0.5rem;height:0.5rem;background:var(--vibeui-dashboard-067-fg);
              ...
              {phases.map((phase) => (
                <div key={phase.name} style={{ display: "contents" }}>
                  ...
                  <div
                    ...
                    title={`${phase.name}: ${STATE_LABELS[phase.state]}`}
                  >
          ...
          <ul data-part="legend">
            ...
            <li>
              <i
                style={{
                  background:
                    "repeating-linear-gradient(135deg,var(--vibeui-dashboard-067-risk) 0 0.25rem,color-mix(in oklab,var(--vibeui-dashboard-067-risk) 72%,black) 0.25rem 0.5rem)",
                }}
              />
              риск срыва
            </li>
