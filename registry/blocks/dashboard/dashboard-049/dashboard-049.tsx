...
--vibeui-dashboard-049-accent:light-dark(oklch(0.55 0.12 39.8),oklch(0.76 0.11 39.8));
--vibeui-dashboard-049-soft:light-dark(oklch(0.96 0 265),oklch(0.32 0.04 39.8));
