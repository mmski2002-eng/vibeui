...
--vibeui-dashboard-064-accent:light-dark(oklch(0.52 0.16 39.8),oklch(0.75 0.14 39.8));
--vibeui-dashboard-064-on-accent:oklch(0.15 0.02 39.8);
--vibeui-dashboard-064-soft:light-dark(oklch(0.965 0.02 320),oklch(0.29 0.035 39.8));
--vibeui-dashboard-064-accent-line:light-dark(oklch(0.84 0.05 39.8),oklch(0.5 0.08 39.8));
...
--vibeui-dashboard-064-remove:light-dark(oklch(0.57 0.19 39.8),oklch(0.75 0.17 39.8));
--vibeui-dashboard-064-remove-soft:light-dark(oklch(0.96 0.025 25),oklch(0.3 0.06 39.8));
--vibeui-dashboard-064-remove-line:light-dark(oklch(0.83 0.09 39.8),oklch(0.49 0.11 39.8));
--vibeui-dashboard-064-partial:light-dark(oklch(0.68 0.15 39.8),oklch(0.81 0.14 39.8));
--vibeui-dashboard-064-partial-line:light-dark(oklch(0.82 0.1 39.8),oklch(0.56 0.11 39.8));
--vibeui-dashboard-064-partial-ink:light-dark(oklch(0.5 0.11 39.8),oklch(0.85 0.12 39.8));
...
:where(.dark,[data-theme="dark"]) [data-vibeui-block="dashboard-064"]{color-scheme:dark}
