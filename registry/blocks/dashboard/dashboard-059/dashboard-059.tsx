...
--vibeui-dashboard-059-card:light-dark(oklch(1 0 0),oklch(0.26 0 250));
--vibeui-dashboard-059-inset:light-dark(oklch(0.97 0 250),oklch(0.22 0 250));
--vibeui-dashboard-059-fg:light-dark(oklch(0.21 0 250),oklch(0.94 0 250));
--vibeui-dashboard-059-muted:light-dark(oklch(0.55 0 250),oklch(0.72 0 250));
--vibeui-dashboard-059-border:light-dark(oklch(0.91 0 250),oklch(0.36 0 250));
--vibeui-dashboard-059-accent:light-dark(oklch(0.55 0.15 39.8),oklch(0.76 0.13 39.8));
--vibeui-dashboard-059-soft:light-dark(oklch(0.965 0 250),oklch(0.31 0.04 39.8));
--vibeui-dashboard-059-ok:light-dark(oklch(0.6 0.13 155),oklch(0.74 0.13 155));
--vibeui-dashboard-059-diff:light-dark(oklch(0.68 0.15 39.8),oklch(0.79 0.14 39.8));
--vibeui-dashboard-059-diff-line:light-dark(oklch(0.85 0.08 39.8),oklch(0.5 0.09 39.8));
--vibeui-dashboard-059-gap:light-dark(oklch(0.57 0.19 39.8),oklch(0.73 0.17 39.8));
--vibeui-dashboard-059-gap-line:light-dark(oklch(0.83 0.09 39.8),oklch(0.47 0.11 39.8));
