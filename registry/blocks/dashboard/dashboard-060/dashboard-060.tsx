...
--vibeui-dashboard-060-accent:light-dark(oklch(0.55 0.13 39.8),oklch(0.76 0.12 39.8));
--vibeui-dashboard-060-on-accent:oklch(0.15 0.02 39.8);
--vibeui-dashboard-060-accent-line:light-dark(oklch(0.85 0.05 39.8),oklch(0.44 0.07 39.8));
--vibeui-dashboard-060-knob:light-dark(oklch(1 0 0),oklch(0.96 0.004 145));
--vibeui-dashboard-060-soft:light-dark(oklch(0.965 0.02 160),oklch(0.31 0.04 39.8));
--vibeui-dashboard-060-block:light-dark(oklch(0.57 0.19 39.8),oklch(0.73 0.17 39.8));
--vibeui-dashboard-060-block-soft:light-dark(oklch(0.96 0.025 25),oklch(0.3 0.05 39.8));
...
--vibeui-dashboard-060-fix:light-dark(oklch(0.55 0.14 39.8),oklch(0.76 0.12 39.8));
--vibeui-dashboard-060-fix-soft:light-dark(oklch(0.96 0 250),oklch(0.3 0.045 39.8));
...
:where(.dark,[data-theme="dark"]) [data-vibeui-block="dashboard-060"]{color-scheme:dark}
