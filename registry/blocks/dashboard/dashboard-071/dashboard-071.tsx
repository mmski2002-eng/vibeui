...
--vibeui-dashboard-071-accent:light-dark(oklch(0.52 0.14 39.8),oklch(0.72 0.13 39.8));
--vibeui-dashboard-071-on-accent:oklch(0.15 0.02 39.8);
--vibeui-dashboard-071-knob:light-dark(oklch(1 0 0),oklch(0.97 0.004 95));
--vibeui-dashboard-071-soft:light-dark(oklch(0.965 0.02 145),oklch(0.3 0.035 39.8));
--vibeui-dashboard-071-stale:light-dark(oklch(0.68 0.15 39.8),oklch(0.8 0.14 39.8));
--vibeui-dashboard-071-stale-line:light-dark(oklch(0.83 0.09 39.8),oklch(0.53 0.11 39.8));
--vibeui-dashboard-071-stale-ink:light-dark(oklch(0.5 0.11 39.8),oklch(0.85 0.12 39.8));
