...
--vibeui-dashboard-065-accent:light-dark(oklch(0.52 0.16 39.8),oklch(0.72 0.14 39.8));
--vibeui-dashboard-065-accent-line:light-dark(oklch(0.78 0.08 39.8),oklch(0.55 0.1 39.8));
--vibeui-dashboard-065-on-accent:oklch(0.15 0.02 39.8);
--vibeui-dashboard-065-on-accent-muted:light-dark(oklch(0.92 0 265),oklch(0.32 0.06 39.8));
--vibeui-dashboard-065-on-accent-chip:light-dark(oklch(0.6 0.14 39.8),oklch(0.62 0.12 39.8));
--vibeui-dashboard-065-on-accent-line:light-dark(oklch(0.72 0.11 39.8),oklch(0.5 0.1 39.8));
--vibeui-dashboard-065-soft:light-dark(oklch(0.965 0 265),oklch(0.3 0.035 39.8));
