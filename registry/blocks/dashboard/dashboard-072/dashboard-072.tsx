...
--vibeui-dashboard-072-accent:light-dark(oklch(0.52 0.16 39.8),oklch(0.73 0.14 39.8));
--vibeui-dashboard-072-accent-line:light-dark(oklch(0.86 0.04 39.8),oklch(0.48 0.07 39.8));
--vibeui-dashboard-072-on-accent:oklch(0.15 0.02 39.8);
--vibeui-dashboard-072-soft:light-dark(oklch(0.965 0 285),oklch(0.3 0.035 39.8));
...
--vibeui-dashboard-072-win:light-dark(oklch(0.58 0.13 39.8),oklch(0.74 0.13 39.8));
--vibeui-dashboard-072-span-win:light-dark(oklch(0.85 0.06 39.8),oklch(0.45 0.07 39.8));
...
:where(.dark,[data-theme="dark"]) [data-vibeui-block="dashboard-072"]{color-scheme:dark}
