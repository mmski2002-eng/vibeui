...
export type Datagrid009Props = Omit<ComponentProps<"section">, "children"> & {
  rows?: Datagrid009Row[]
  caption?: string
  minWidth?: number
...
:where(.dark,[data-theme="dark"]) [data-vibeui-block="datagrid-009"]{color-scheme:dark}
...
background:var(--vibeui-datagrid-009-accent);color:oklch(from var(--vibeui-datagrid-009-accent) clamp(0,(0.62 - l) * 100,1) 0 0);}
