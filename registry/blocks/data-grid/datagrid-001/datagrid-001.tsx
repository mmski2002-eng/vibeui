...
[data-vibeui-block="datagrid-001"] [data-part="bar"]{display:flex;flex-wrap:wrap;align-items:center;gap:0.5rem;
padding:0.75rem 0.875rem;border-bottom:1px solid var(--vibeui-datagrid-001-border);}
[data-vibeui-block="datagrid-001"] [data-part="bar"] [data-part="bar-title"]{margin:0;font-size:0.875rem;font-weight:650;margin-inline-end:auto;}
[data-vibeui-block="datagrid-001"] [data-part="bar"] [data-part="chips"]{display:flex;flex-wrap:wrap;align-items:center;gap:0.375rem;
margin:0;padding:0;list-style:none;}
[data-vibeui-block="datagrid-001"] [data-part="bar"] [data-part="chip"]{display:inline-flex;align-items:center;gap:0.375rem;
...
[data-vibeui-block="datagrid-001"] [data-part="bar"] [data-part="chip"]:hover{border-color:var(--vibeui-datagrid-001-accent)}
[data-vibeui-block="datagrid-001"] [data-part="bar"] [data-part="chip"]:focus-visible{outline:2px solid var(--vibeui-datagrid-001-accent);outline-offset:2px}
[data-vibeui-block="datagrid-001"] [data-part="bar"] [data-part="empty-sort"]{font-size:0.75rem;color:var(--vibeui-datagrid-001-muted);}
[data-vibeui-block="datagrid-001"] [data-part="bar"] [data-part="reset"]{appearance:none;cursor:pointer;font:inherit;font-size:0.75rem;
...
[data-vibeui-block="datagrid-001"] [data-part="bar"] [data-part="reset"]:hover:not(:disabled){color:var(--vibeui-datagrid-001-fg)}
[data-vibeui-block="datagrid-001"] [data-part="bar"] [data-part="reset"]:disabled{opacity:.45;cursor:not-allowed}
[data-vibeui-block="datagrid-001"] [data-part="bar"] [data-part="reset"]:focus-visible{outline:2px solid var(--vibeui-datagrid-001-accent);outline-offset:2px}
`
  ...
  return (
    <>
      ...
      <section
        ...
        style={palette}
      >
        <Bar data-part="bar" heading={heading} emptySortText={emptySortText} removeSortLabel={removeSortLabel} resetText={resetText} keys={keys} label={label} setKeys={setKeys} accent={accent} />
        <div
          data-part="scroll"
          role="region"
