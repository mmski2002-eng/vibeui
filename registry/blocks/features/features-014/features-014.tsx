...
--vibeui-features-014-bg:oklch(0.98 0.008 70);
--vibeui-features-014-fg:oklch(0.19 0.014 60);
--vibeui-features-014-muted:oklch(0.49 0.016 60);
--vibeui-features-014-line:oklch(0.87 0.014 60);
--vibeui-features-014-panel:oklch(1 0 0);
--vibeui-features-014-accent:oklch(0.48 0.14 40);
