...
[data-vibeui-block="testimonials-023"] [data-part="slot"]{width:15.5rem}
...
@media (prefers-reduced-motion:reduce){[data-vibeui-block="testimonials-023"] *{animation:none!important;transition:none!important}[data-vibeui-block="testimonials-023"] [data-part="word"] i{transform:none}[data-vibeui-block="testimonials-023"] [data-part="lede"]{opacity:1;translate:none}}`
        ...
        <div data-part="shell">
          ...
          <div data-part="row">
            {reviews.map((review, index) => (
              <Card110 key={review.no} data-part="slot" {...review} reviewLabel={reviewLabel} brand={brand} place={place} totalLabel={totalLabel} guestLabel={guestLabel} thanks={thanks} index={index} accent={accent} />
            ))}
          </div>
        </div>
      </section>
