...
[data-vibeui-block="testimonials-024"][data-in="true"] [data-part="note"]{opacity:1;animation:vibeui-testimonials-024-rise .8s var(--vibeui-testimonials-024-ease) backwards;animation-delay:calc(var(--vibeui-testimonials-024-i) * .1s)}
[data-vibeui-block="testimonials-024"][data-in="true"] [data-part="note"]:hover{transform:rotate(calc(var(--vibeui-testimonials-024-r) * .4deg)) translateY(-.3rem)}
[data-vibeui-block="testimonials-024"][data-in="true"] [data-part="note"][data-active="true"]{transform:rotate(0) translateY(-.4rem) scale(1.04);box-shadow:0 1px 0 var(--vibeui-testimonials-024-line),0 36px 60px -30px color-mix(in oklab,var(--vibeui-testimonials-024-accent) 55%,rgb(0 0 0 / .5));z-index:2}
...
[data-vibeui-block="testimonials-024"] [data-part="quote"]{position:relative;margin:0;font-family:var(--vibeui-testimonials-024-display);font-weight:600;font-size:clamp(1.15rem,1.6cqi,1.45rem);line-height:1.3;letter-spacing:-.02em;text-wrap:pretty}
...
[data-vibeui-block="testimonials-024"] [data-part="who"]{position:relative;display:flex;align-items:baseline;gap:.6rem;flex-wrap:wrap;margin-top:1.4rem}
[data-vibeui-block="testimonials-024"] [data-part="who"] b{font-family:var(--vibeui-testimonials-024-hand);font-weight:600;font-size:1.5rem;line-height:1;color:var(--vibeui-testimonials-024-accent)}
[data-vibeui-block="testimonials-024"] [data-part="who"] span{font-size:.85rem;color:var(--vibeui-testimonials-024-muted)}
[data-vibeui-block="testimonials-024"] [data-part="who"] i{font-style:normal;font-family:var(--vibeui-testimonials-024-mono);font-size:.68rem;padding:.2rem .5rem;border-radius:4px;border:1px solid var(--vibeui-testimonials-024-line);margin-left:auto}
[data-vibeui-block="testimonials-024"] [data-part="bar"]{position:absolute;left:1.6rem;right:1.6rem;bottom:.9rem;height:2px;background:var(--vibeui-testimonials-024-line);overflow:hidden;opacity:0;transition:opacity .3s}
[data-vibeui-block="testimonials-024"] [data-part="note"][data-active="true"] [data-part="bar"]{opacity:1}
[data-vibeui-block="testimonials-024"] [data-part="bar"]::after{content:"";position:absolute;inset:0;background:var(--vibeui-testimonials-024-accent);transform:scaleX(0);transform-origin:left}
...
[data-vibeui-block="testimonials-024"][data-paused="true"] [data-part="bar"]::after{animation-play-state:paused}
...
@container (min-width: 60rem){[data-vibeui-block="testimonials-024"] [data-part="board"]{grid-template-columns:repeat(3,minmax(0,1fr));gap:2.4rem;padding:1rem 0}[data-vibeui-block="testimonials-024"] [data-part="note"]{padding:2.6rem 1.8rem 2rem}}
@media (prefers-reduced-motion:reduce){[data-vibeui-block="testimonials-024"] *{animation:none!important;transition:none!important}[data-vibeui-block="testimonials-024"] [data-part="note"]{opacity:1}[data-vibeui-block="testimonials-024"] [data-part="top"]{opacity:1;transform:none}[data-vibeui-block="testimonials-024"] [data-part="note"][data-active="true"] [data-part="bar"]::after{transform:none}}`
          ...
          <ul data-part="board">
            {quotes.map((quote, i) => (
              <li
                ...
                style={{ ["--vibeui-testimonials-024-i" as string]: i, ["--vibeui-testimonials-024-r" as string]: TILTS[i % TILTS.length] }}
                onClick={() => setIndex(i)}
                onPointerMove={spot}
                onKeyDown={(event) => {
              ...
              >
                <blockquote data-part="quote">{quote.text}</blockquote>
                <div data-part="who">
                  <b>{quote.name}</b>
