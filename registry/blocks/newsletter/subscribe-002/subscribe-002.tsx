...
--vibeui-subscribe-002-accent:light-dark(oklch(0.64 0.2144 39.8),oklch(0.6803 0.2144 39.8));
--vibeui-subscribe-002-accent-ink:light-dark(oklch(0.55 0.2144 39.8),oklch(0.6803 0.2144 39.8));
--vibeui-subscribe-002-on-accent:oklch(0.15 0.02 39.8);
--vibeui-subscribe-002-ok:light-dark(oklch(0.52 0.14 150),oklch(0.76 0.14 150));
--vibeui-subscribe-002-shadow:light-dark(oklch(0.2 0.02 40 / 55%),oklch(0.05 0 0 / 85%));
...
background:var(--vibeui-subscribe-002-accent);color:var(--vibeui-subscribe-002-on-accent);
