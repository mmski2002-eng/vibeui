...
[data-vibeui-block="subscribe-020"]{box-sizing:border-box;padding:clamp(4rem,8cqi,7rem) 0;background:var(--vibeui-subscribe-020-bg);color:var(--vibeui-subscribe-020-fg);font-family:var(--vibeui-subscribe-020-font);font-size:1.05rem;line-height:1.65;transition:background-color .6s,color .6s}
...
[data-vibeui-block="subscribe-020"] [data-part="title"]{margin:0;font-family:var(--vibeui-subscribe-020-display);font-weight:400;font-size:clamp(2.4rem,6cqi,4.4rem);line-height:1;letter-spacing:-.02em}
...
[data-vibeui-block="subscribe-020"] [data-part="scene"]{display:grid;justify-items:center;gap:1rem;padding-top:6rem}
...
[data-vibeui-block="subscribe-020"] [data-part="pocket"]{position:absolute;inset:0;border-radius:.4rem;z-index:2;background:var(--vibeui-subscribe-020-envelope);clip-path:polygon(0 0,50% 55%,100% 0,100% 100%,0 100%);box-shadow:inset 0 1px 0 rgb(255 255 255 / .12)}
[data-vibeui-block="subscribe-020"] [data-part="envelope"]:hover [data-part="flap"],[data-vibeui-block="subscribe-020"] [data-part="envelope"][aria-pressed="true"] [data-part="flap"]{transform:rotateX(-170deg);z-index:0}
[data-vibeui-block="subscribe-020"] [data-part="envelope"]:hover [data-part="seal"],[data-vibeui-block="subscribe-020"] [data-part="envelope"][aria-pressed="true"] [data-part="seal"]{opacity:0;transform:scale(.4)}
[data-vibeui-block="subscribe-020"] [data-part="envelope"]:hover [data-part="letter"],[data-vibeui-block="subscribe-020"] [data-part="envelope"][aria-pressed="true"] [data-part="letter"]{transform:translateY(-46%)}
...
export function Subscribe020({
  ...
  return (
    <>
      ...
      <section data-vibeui-block="subscribe-020" data-tone={tone === "auto" ? undefined : tone} data-mode={mode ?? undefined} className={className} style={palette}>
        <div data-part="shell">
