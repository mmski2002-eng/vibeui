...
--vibeui-pres-001-accent:light-dark(oklch(0.55 0.2144 39.8),oklch(0.6803 0.2144 39.8));
...
const DEFAULT_MENTIONS: Pres001Item[] = [
  { outlet: "ТехВестник", quote: "VibeUI переворачивает подход к сборке интерфейсов вместе с ИИ.", date: "Сентябрь 2026" },
  { outlet: "Код и Кофе", quote: "Наконец-то библиотека, где компоненты приходят готовыми файлами, а не зависимостями.", date: "Август 2026" },
  { outlet: "Диджитал Обзор", quote: "Инструмент, который экономит командам недели работы над лендингами.", date: "Июль 2026" },
]
