...
--vibeui-logocloud-003-dur-2:180ms;
...
transition:border-color var(--vibeui-logocloud-003-dur-2) ease,background-color var(--vibeui-logocloud-003-dur-2) ease;
}
...
transition:color var(--vibeui-logocloud-003-dur-2) ease;
