...
--vibeui-case-003-accent:light-dark(oklch(0.55 0.2144 39.8),oklch(0.6803 0.2144 39.8));
...
[data-vibeui-block="case-003"] [data-part="eyebrow"]{
margin:0 0 0.625rem;color:var(--vibeui-case-003-accent);
font-size:0.75rem;font-weight:700;letter-spacing:0.12em;text-transform:uppercase;
}
[data-vibeui-block="case-003"] [data-part="title"]{
...
export function Case003({
  ...
  return (
    <>
      ...
      <section data-vibeui-block="case-003" className={className} style={palette}>
        <div data-part="shell">
