...
--vibeui-comparison-002-accent:light-dark(oklch(0.55 0.2144 39.8),oklch(0.6803 0.2144 39.8));
...
[data-vibeui-block="comparison-002"] [data-part="point"]::before{content:"";position:absolute;left:0.1875rem;top:0.5rem;width:0.5rem;height:0.5rem;border-radius:999px;background:var(--vibeui-comparison-002-accent)}
...
const DEFAULT_PLANS: Comparison002Plan[] = [
  {
    ...
    points: ["Часы на промпты и правки", "Разъезжающийся дизайн", "Нет доступности"],
  },
  {
    name: "VibeUI",
    tagline: "Агент ставит тот же файл из реестра",
    points: ["Ноль зависимостей", "Инструкция в комплекте", "Доступность на месте"],
    highlight: true,
  },
  {
    name: "Обычная библиотека",
    tagline: "Тянет за собой пакет и свою тему",
    points: ["Десятки мегабайт зависимостей", "Привязка к чужой теме", "Ломается при обновлении"],
  },
]
