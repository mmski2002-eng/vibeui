...
--vibeui-comparison-004-accent:light-dark(oklch(0.55 0.2144 39.8),oklch(0.6803 0.2144 39.8));
--vibeui-comparison-004-accent-soft:light-dark(oklch(0.55 0.2144 39.8 / 8%),oklch(0.6803 0.2144 39.8 / 14%));
