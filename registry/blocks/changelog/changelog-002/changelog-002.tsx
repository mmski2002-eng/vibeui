...
--vibeui-changelog-002-accent:light-dark(oklch(0.55 0.2144 39.8),oklch(0.6803 0.2144 39.8));
...
const DEFAULT_CHANGES: Changelog002Change[] = [
  { tag: "Добавлено", text: "Шесть новых категорий блоков: ошибки, команда, кейсы, логотипы." },
  { tag: "Добавлено", text: "Встроенное меню у кнопки с раздельным действием." },
  { tag: "Изменено", text: "Акцент интерфейса переведён на фирменный оранжевый." },
  { tag: "Исправлено", text: "Выпадающее меню больше не обрезается краем карточки." },
]
