...
const DEFAULT_ENTRIES: Changelog003Entry[] = [
  { version: "v2.4.0", date: "6 сен 2026", type: "Новое", text: "Шесть новых категорий блоков в каталоге." },
  { version: "v2.4.0", date: "6 сен 2026", type: "Улучшение", text: "Поиск подсвечивает совпадение в карточке." },
  { version: "v2.3.1", date: "28 авг 2026", type: "Исправление", text: "Тёмная подложка превью больше не мигает." },
  { version: "v2.3.0", date: "14 авг 2026", type: "Улучшение", text: "Copy for AI собирает инструкцию из метаданных." },
  { version: "v2.3.0", date: "14 авг 2026", type: "Новое", text: "Переключатель темы оболочки каталога." },
]
