...
import {
  Accordion020,
  type Accordion020Item,
} from "@/registry/components/accordion/accordion-020/accordion-020"

export type Faq020Item = Accordion020Item
...
/* Список вопросов — accordion-020, ему отдаётся вся колонка. */
[data-vibeui-block="faq-020"] [data-part="list"]{width:100%;max-width:none}
