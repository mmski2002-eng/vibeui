...
--vibeui-download-005-accent:light-dark(oklch(0.55 0.2144 39.8),oklch(0.6803 0.2144 39.8));
--vibeui-download-005-accent-ink:oklch(1 0 0);
...
width:0.375rem;height:0.375rem;border-radius:999px;background:var(--vibeui-download-005-accent);
}
...
background:var(--vibeui-download-005-accent);color:var(--vibeui-download-005-accent-ink);
