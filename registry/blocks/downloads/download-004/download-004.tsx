...
--vibeui-download-004-accent:light-dark(oklch(0.55 0.2144 39.8),oklch(0.6803 0.2144 39.8));
...
color:var(--vibeui-download-004-ink);transition:border-color .18s ease,transform .18s ease;
}
