...
--vibeui-podcast-001-accent:light-dark(oklch(0.55 0.2144 39.8),oklch(0.6803 0.2144 39.8));
--vibeui-podcast-001-on-accent:oklch(0.15 0.02 39.8);
...
background:var(--vibeui-podcast-001-accent);
}
