...
transition:filter var(--vibeui-errorpage-002-dur-2) ease;
}
...
transition:border-color var(--vibeui-errorpage-002-dur-2) ease,color var(--vibeui-errorpage-002-dur-2) ease;
}
