...
import { Button116 } from "@/registry/components/button/button-116/button-116"
        ...
        <div data-part="shell">
          <div data-part="copy">
            ...
            <div data-part="badges">
              {badges.map((badge) => (
                <Button116 key={badge.store} data-part="badge" store={badge.store} href={badge.href} caption={badge.caption} accent={accent} />
              ))}
            </div>
          </div>
