...
--vibeui-cta-007-accent:light-dark(oklch(0.55 0.2144 39.8),oklch(0.6803 0.2144 39.8));
--vibeui-cta-007-button:light-dark(oklch(0.64 0.2144 39.8),oklch(0.6803 0.2144 39.8));
--vibeui-cta-007-button-ink:oklch(0.15 0.02 39.8);
...
export function Cta007({
  ...
  return (
    <>
      ...
      <section data-vibeui-block="cta-007" className={className} style={palette}>
        <div data-part="shell">
