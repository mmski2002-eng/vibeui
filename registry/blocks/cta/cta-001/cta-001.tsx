...
--vibeui-cta-001-bg:oklch(0.21 0.02 265);
--vibeui-cta-001-ink:oklch(0.98 0.003 265);
--vibeui-cta-001-muted:oklch(0.76 0.012 265);
--vibeui-cta-001-accent:oklch(0.72 0.16 195);
--vibeui-cta-001-accent-fg:oklch(0.16 0.02 265);
--vibeui-cta-001-border:oklch(1 0 0 / 14%);
