...
[data-vibeui-block="download-001"] [data-part="badge"]{display:inline-flex;align-items:center;gap:0.5rem;box-sizing:border-box;
...
[data-vibeui-block="download-001"] [data-part="badge"] [data-part="text"]{display:flex;flex-direction:column;gap:0.125rem;line-height:1}
[data-vibeui-block="download-001"] [data-part="badge"] [data-part="kicker"]{font-size:0.5625rem;line-height:1.1;letter-spacing:0.01em}
[data-vibeui-block="download-001"] [data-part="badge"] [data-part="store"]{font-size:1.0625rem;font-weight:600;line-height:1.1;letter-spacing:-0.01em;white-space:nowrap}
`
...
type BadgeProps = Omit<ComponentProps<"a">, "title" | "children"> & {
  name?: string
  href?: string
  kicker?: string
  accent?: string
      ...
      >
        <div data-part="shell">
          ...
          <div data-part="badges">
            {stores.map((store) => (
              <Badge key={store.name} data-part="badge" name={store.name} href={store.href} kicker={store.kicker} accent={accent} />
            ))}
          </div>
        </div>
      </section>
