...
import { Card123 } from "@/registry/components/card/card-123/card-123"
        ...
        <div data-part="shell">
          ...
          <div data-part="grid">
            <div>
              <ul data-part="cards">
                {cards.map((card) => (
                  <Card123 key={card.title} data-part="card" title={card.title} icon={card.icon} value={card.value} text={card.text} accent={accent} />
                ))}
              </ul>
              {contactName ? (
