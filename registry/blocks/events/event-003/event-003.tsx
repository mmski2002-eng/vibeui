...
--vibeui-event-003-accent:light-dark(oklch(0.55 0.2144 39.8),oklch(0.6803 0.2144 39.8));
...
[data-vibeui-block="event-003"] [data-part="eyebrow"]{margin:0 0 0.5rem;color:var(--vibeui-event-003-accent);font-size:0.75rem;font-weight:700;letter-spacing:0.12em;text-transform:uppercase}
[data-vibeui-block="event-003"] [data-part="title"]{margin:0 0 2rem;font-size:clamp(1.625rem,5cqi,2.5rem);line-height:1.1;letter-spacing:-0.025em;font-weight:700}
...
[data-vibeui-block="event-003"] [data-part="bar"]{height:0.375rem;background:linear-gradient(90deg,oklch(0.62 0.19 39.8),oklch(0.5 0.15 25))}
