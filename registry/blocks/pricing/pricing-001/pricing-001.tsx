...
--vibeui-pricing-001-accent:light-dark(oklch(0.287 0 0),oklch(0.903 0 0));
--vibeui-pricing-001-accent-fg:oklch(from var(--vibeui-pricing-001-accent) clamp(0,(0.62 - l) * 100,1) 0 0);
