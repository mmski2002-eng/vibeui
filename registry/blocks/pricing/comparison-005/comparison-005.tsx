...
--vibeui-comparison-005-accent:light-dark(oklch(0.287 0 0),oklch(0.892 0 0));
--vibeui-comparison-005-accent-soft:light-dark(oklch(0.287 0 0 / 10%),oklch(0.892 0 0 / 16%));
