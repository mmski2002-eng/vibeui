...
--vibeui-pricing-007-fg:light-dark(oklch(0.2 0 240),oklch(0.95 0 240));
...
:where(.dark,[data-theme="dark"]) [data-vibeui-block="pricing-007"]{color-scheme:dark}
...
display:grid;gap:0.875rem;padding:1.5rem;border-radius:1.125rem;border:1px solid var(--vibeui-pricing-007-line);background:var(--vibeui-pricing-007-card);
}
[data-vibeui-block="pricing-007"] [data-part="pair"]{display:grid;gap:0.875rem}
[data-vibeui-block="pricing-007"] [data-part="formtitle"]{margin:0 0 0.375rem;font-size:1rem;font-weight:700}
[data-vibeui-block="pricing-007"] label{font-size:0.8125rem;font-weight:600}
[data-vibeui-block="pricing-007"] [data-part="privacy"]{margin:0;font-size:0.75rem;line-height:1.5;color:var(--vibeui-pricing-007-muted)}
@container (min-width: 34rem){
[data-vibeui-block="pricing-007"] [data-part="shell"]{padding:5rem 2rem}
[data-vibeui-block="pricing-007"] form{padding:1.875rem}
[data-vibeui-block="pricing-007"] [data-part="pair"]{grid-template-columns:repeat(2,minmax(0,1fr))}
}
