...
export type Footer020Link = {
  label: string
  href: string
}

export type Footer020Hours = {
  days: string
  time: string
}

export type Footer020Props = {
  brand?: string
  caption?: string
  address?: string
  hours?: readonly Footer020Hours[]
  phone?: string
  phoneHref?: string
  email?: string
  messengersLabel?: string
  messengers?: readonly Footer020Messenger[]
...
:where(.dark,[data-theme="dark"]) [data-vibeui-block="footer-020"]{color-scheme:dark}
:where([data-vibeui-block="footer-020"][data-tone="light"]){color-scheme:light}
...
[data-vibeui-block="footer-020"] [data-part="top"]{display:grid;gap:2.25rem;padding-bottom:2.5rem;border-bottom:1px solid var(--vibeui-footer-020-line)}
[data-vibeui-block="footer-020"] [data-part="brand"]{margin:0;font-family:var(--vibeui-footer-020-display);font-size:2.2rem;font-weight:500;line-height:1;letter-spacing:.04em;text-transform:uppercase}
[data-vibeui-block="footer-020"] [data-part="caption"]{margin:.5rem 0 0;font-size:.68rem;letter-spacing:.16em;text-transform:uppercase;color:var(--vibeui-footer-020-muted)}
[data-vibeui-block="footer-020"] address{font-style:normal;margin:1.25rem 0 0;color:var(--vibeui-footer-020-muted);max-width:20rem}
[data-vibeui-block="footer-020"] [data-part="label"]{display:block;margin:0 0 .6rem;font-size:.68rem;letter-spacing:.16em;text-transform:uppercase;color:var(--vibeui-footer-020-muted)}
[data-vibeui-block="footer-020"] [data-part="hours"]{margin:0;display:grid;grid-template-columns:auto 1fr;gap:.3rem 1.25rem;font-size:.9rem}
[data-vibeui-block="footer-020"] [data-part="hours"] dt{color:var(--vibeui-footer-020-muted)}
[data-vibeui-block="footer-020"] [data-part="hours"] dd{margin:0;font-variant-numeric:tabular-nums}
[data-vibeui-block="footer-020"] [data-part="phone"]{display:inline-block;font-family:var(--vibeui-footer-020-display);font-size:1.75rem;line-height:1.1}
[data-vibeui-block="footer-020"] [data-part="email"]{display:inline-block;margin-top:.75rem;border-bottom:1px solid var(--vibeui-footer-020-accent);padding-bottom:.1rem}
[data-vibeui-block="footer-020"] [data-part="messengers"]{display:flex;flex-wrap:wrap;gap:.5rem;margin:1.25rem 0 0;padding:0;list-style:none}
[data-vibeui-block="footer-020"] [data-part="messenger"]{display:inline-flex;align-items:center;gap:.5rem;height:2.5rem;padding:0 .9rem 0 .4rem;border-radius:999px;background:var(--vibeui-footer-020-chip);border:1px solid var(--vibeui-footer-020-line);font-weight:600;font-size:.8rem;transition:border-color .2s,transform .2s}
...
export function Footer020({
  ...
  return (
    <>
      ...
      <style href="vibeui-footer-020" precedence="medium">
        {STYLES}
      </style>
      <footer data-vibeui-block="footer-020" data-tone={tone === "auto" ? undefined : tone} className={className} style={palette}>
        <div data-part="shell">
          <div data-part="top">
            <div>
