...
[data-vibeui-block="footer-007"] [data-part="column"] [data-part="column-title"]{margin:0 0 0.75rem;color:var(--vibeui-footer-007-ink);
font-size:0.75rem;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;}
[data-vibeui-block="footer-007"] [data-part="column"] ul{margin:0;padding:0;list-style:none;display:grid;gap:0.5rem}
[data-vibeui-block="footer-007"] [data-part="column"] a{color:var(--vibeui-footer-007-muted);text-decoration:none;font-size:0.875rem;
transition:color var(--vibeui-footer-007-dur-2) ease;}
