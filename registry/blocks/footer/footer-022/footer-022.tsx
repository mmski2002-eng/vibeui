...
[data-vibeui-block="footer-022"] [data-part="column"] [data-part="col-title"]{margin:0 0 .75rem;font-family:var(--vibeui-footer-022-display);font-size:1.15rem;font-weight:600;letter-spacing:-.01em}
[data-vibeui-block="footer-022"] [data-part="column"] [data-part="links"]{display:grid;gap:.5rem;margin:0;padding:0;list-style:none;font-size:1rem}
[data-vibeui-block="footer-022"] [data-part="column"] [data-part="links"] a{transition:opacity .2s}
[data-vibeui-block="footer-022"] [data-part="column"] [data-part="links"] a:hover{opacity:.6}
`
