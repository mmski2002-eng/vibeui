...
[data-vibeui-block="footer-035"] [data-part="word"]{margin:2.5rem 0 0;padding:0;font-family:var(--vibeui-footer-035-display);font-style:italic;font-weight:600;font-size:clamp(3.5rem,14cqi,10.5rem);line-height:.85;letter-spacing:-.02em;text-align:center;color:transparent;-webkit-text-stroke:1.5px var(--vibeui-footer-035-fg);filter:drop-shadow(0 0 26px color-mix(in oklab,var(--vibeui-footer-035-accent) 22%,transparent));transition:color .6s cubic-bezier(.2,.7,.2,1),filter .6s;user-select:none;-webkit-user-select:none}
[data-vibeui-block="footer-035"] [data-part="word"]:hover{color:var(--vibeui-footer-035-fg);filter:drop-shadow(0 0 40px color-mix(in oklab,var(--vibeui-footer-035-accent) 45%,transparent))}
