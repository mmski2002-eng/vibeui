...
@container (min-width: 64rem){[data-vibeui-block="footer-036"] [data-part="frame"]{grid-template-columns:18rem minmax(0,1fr) 16rem;grid-template-areas:"brand cells links" "bottom bottom bottom"}[data-vibeui-block="footer-036"] [data-part="brand"]{grid-area:brand;border-bottom:0;border-right:1px solid var(--vibeui-footer-036-fg)}[data-vibeui-block="footer-036"] [data-part="cells"]{grid-area:cells;grid-template-columns:repeat(2,minmax(0,1fr));align-content:start;border-right:1px solid var(--vibeui-footer-036-fg)}[data-vibeui-block="footer-036"] [data-part="cell"]:nth-child(4n){border-right:1px solid var(--vibeui-footer-036-fg)}[data-vibeui-block="footer-036"] [data-part="cell"]:nth-child(2n){border-right:0}[data-vibeui-block="footer-036"] [data-part="links"]{grid-area:links;border-bottom:0;grid-template-columns:1fr;align-content:start}[data-vibeui-block="footer-036"] [data-part="bottom"]{grid-area:bottom;border-top:1px solid var(--vibeui-footer-036-fg)}}
