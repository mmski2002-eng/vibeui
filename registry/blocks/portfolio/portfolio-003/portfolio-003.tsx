...
const DEFAULT_CASES: Portfolio003Case[] = [
  { client: "Финпилот", title: "Собрали лендинг тарифов за один спринт", result: "−60% времени" },
  { client: "Кедр Маркет", title: "Переехали на собственный сайт без фронтендера", result: "×3 конверсия" },
  { client: "Полдень", title: "Промо запуска лампы под кампанию", result: "12 тыс. предзаказов" },
  { client: "Курс.Лаб", title: "Методисты сами запускают посадочные", result: "8 страниц в неделю" },
]
