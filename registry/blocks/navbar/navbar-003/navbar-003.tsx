...
transition:transform .22s var(--vibeui-navbar-003-ease);
}
...
opacity:1;
transition:transform .32s var(--vibeui-navbar-003-ease),width .32s var(--vibeui-navbar-003-ease),opacity .18s ease;
}
...
inset 0 1px 0 color-mix(in oklab,#ffffff 42%,transparent);
transition:transform .18s var(--vibeui-navbar-003-ease),box-shadow .25s ease;
}
[data-vibeui-block="navbar-003"] [data-part="action"] svg{
width:0.875rem;height:0.875rem;flex:none;
transition:transform .24s var(--vibeui-navbar-003-ease);
}
...
transition:transform .3s var(--vibeui-navbar-003-ease);
}
...
transition:opacity .18s ease,transform .26s var(--vibeui-navbar-003-ease);
}
