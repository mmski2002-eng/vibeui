...
[data-vibeui-block="hero-030"] [data-part="copy-button"]{flex:none}
[data-vibeui-block="hero-030"] [data-part="primary"]{transform:translate(calc(var(--vibeui-hero-030-mx,0) * 1px),calc(var(--vibeui-hero-030-my,0) * 1px));transition:transform .25s cubic-bezier(.2,.8,.2,1)}
...
[data-vibeui-block="hero-030"] [data-part="output"]{margin:0;padding:1rem 1.1rem 1.2rem;min-height:15rem;white-space:pre-wrap;word-break:break-word;transition:opacity .4s}
[data-vibeui-block="hero-030"] [data-part="output"][data-fade="true"]{opacity:0}
[data-vibeui-block="hero-030"] [data-part="output"] > span{display:block;animation:vibeui-hero-030-line .3s ease-out}
[data-vibeui-block="hero-030"] [data-part="output"] b{font-weight:500;color:var(--vibeui-hero-030-green)}
[data-vibeui-block="hero-030"] [data-part="output"] [data-kind="ok"]{color:var(--vibeui-hero-030-green)}
[data-vibeui-block="hero-030"] [data-part="output"] [data-kind="out"]{color:color-mix(in oklab,var(--vibeui-hero-030-term-fg) 70%,transparent)}
...
[data-vibeui-block="hero-030"] button:focus-visible{outline:2px solid var(--vibeui-hero-030-accent);outline-offset:2px}
          ...
          <div data-part="row">
            <div>
              ...
              <div data-part="install" data-reveal="" style={reveal(1)}>
                ...
                <div data-part="cmd">
                  ...
                  <Button015 data-part="copy-button" value={managers[manager].command} label={copyLabel} doneLabel={copiedLabel} />
                </div>
              </div>
            ...
            <div data-part="scene" data-reveal="" style={reveal(2)}>
              <div data-part="term" aria-label={terminalLabel} onPointerMove={tilt} onPointerLeave={untilt}>
                ...
                <pre data-part="output" data-fade={fading}>
