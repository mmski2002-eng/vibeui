...
--vibeui-hero-004-bg:oklch(0.98 0.004 95);
--vibeui-hero-004-fg:oklch(0.21 0.012 95);
--vibeui-hero-004-muted:oklch(0.52 0.012 95);
--vibeui-hero-004-line:oklch(0.89 0.008 95);
--vibeui-hero-004-accent:oklch(0.47 0.14 27);
--vibeui-hero-004-accent-fg:oklch(0.99 0 0);
