...
[data-vibeui-block="hero-021"]{box-sizing:border-box;position:relative;display:grid;min-height:100svh;overflow:hidden;background:var(--vibeui-hero-021-bg);color:var(--vibeui-hero-021-fg);font-family:var(--vibeui-hero-021-font);font-size:.9375rem;line-height:1.5;color-scheme:dark}
[data-vibeui-block="hero-021"] *{box-sizing:border-box}
[data-vibeui-block="hero-021"] [data-part="picture"]{position:absolute;inset:0;width:100%;height:100%;object-fit:cover;animation:vibeui-hero-021-drift 28s ease-in-out infinite alternate;filter:saturate(.9)}
@keyframes vibeui-hero-021-drift{from{transform:scale(1.02)}to{transform:scale(1.12)}}
[data-vibeui-block="hero-021"] [data-part="shade"]{position:absolute;inset:0;background:radial-gradient(60rem 30rem at 18% 90%,rgb(125 42 58 / .28),transparent 60%),linear-gradient(to top,rgb(20 17 16 / .95) 0%,rgb(20 17 16 / .55) 45%,rgb(20 17 16 / .25) 100%)}
[data-vibeui-block="hero-021"] [data-part="shell"]{position:relative;z-index:1;display:flex;flex-direction:column;justify-content:flex-end;max-width:80rem;width:100%;margin:0 auto;padding:8rem 1.25rem 3rem;min-height:calc(100svh - 3.2rem)}
[data-vibeui-block="hero-021"] [data-part="eyebrow"]{margin:0 0 1rem;font-size:.75rem;letter-spacing:.24em;text-transform:uppercase;color:#e8c9a6;font-weight:600;text-shadow:0 1px 10px rgb(0 0 0 / .4);animation:vibeui-hero-021-fade .8s .2s both}
[data-vibeui-block="hero-021"] [data-part="title"]{margin:0;font-family:var(--vibeui-hero-021-display);font-weight:400;font-size:clamp(2.75rem,9cqi,7rem);line-height:.98;letter-spacing:-.02em;text-wrap:balance}
[data-vibeui-block="hero-021"] [data-part="line"]{display:block;overflow:hidden;padding-bottom:.08em;margin-bottom:-.08em}
[data-vibeui-block="hero-021"] [data-part="line"] > span{display:block;transform:translateY(110%);animation:vibeui-hero-021-rise 1s cubic-bezier(.2,.8,.2,1) forwards;animation-delay:calc(.3s + var(--vibeui-hero-021-n) * .14s)}
[data-vibeui-block="hero-021"] [data-part="line"] em{font-style:italic;color:var(--vibeui-hero-021-accent-ink);text-shadow:0 0 30px rgb(125 42 58 / .55),0 0 80px rgb(125 42 58 / .3)}
@keyframes vibeui-hero-021-rise{to{transform:none}}
...
[data-vibeui-block="hero-021"] [data-part="track"] span::after{content:"";width:.35rem;height:.35rem;border-radius:50%;background:var(--vibeui-hero-021-accent);box-shadow:0 0 10px rgb(125 42 58 / .8)}
@keyframes vibeui-hero-021-ticker{to{transform:translateX(-50%)}}
@container (min-width: 56rem){[data-vibeui-block="hero-021"] [data-part="shell"]{padding:9rem 2rem 4rem}}
@media (prefers-reduced-motion:reduce){[data-vibeui-block="hero-021"] *{animation:none!important;transition:none!important}[data-vibeui-block="hero-021"] [data-part="line"] > span{transform:none}}`
...
export function Hero021({
  ...
  return (
    <>
      ...
      <style href="vibeui-hero-021" precedence="medium">
        {STYLES}
      </style>
      <section data-vibeui-block="hero-021" data-tone={tone === "auto" ? undefined : tone} className={className} style={palette}>
        ...
        <div data-part="shell">
          ...
          <h1 data-part="title">
            {lines.map((line, index) => (
              <span key={line} data-part="line" style={{ ["--vibeui-hero-021-n" as string]: index }}>
