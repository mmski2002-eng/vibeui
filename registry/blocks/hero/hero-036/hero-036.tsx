...
[data-vibeui-block="hero-036"] [data-part="arch"]{position:absolute;left:8%;top:0;width:72%;height:88%;margin:0;overflow:hidden;border-radius:1.75rem;background:var(--vibeui-hero-036-line);box-shadow:0 30px 60px -30px rgb(0 0 0 / .45);opacity:0;animation:vibeui-hero-036-rise 1.1s cubic-bezier(.2,.7,.2,1) forwards;animation-delay:calc(.15s + var(--vibeui-hero-036-i) * .2s)}
