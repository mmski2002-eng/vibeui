...
export const SCENARIOS: Scenario[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { item: "hero-038", anchor: "top", role: "Первый экран", roleEn: "First screen", note: "Обратный отсчёт доставки, бургер из шести CSS-слоёв, пар, бегущая строка блюд.", noteEn: "A delivery countdown, a burger of six CSS layers, steam, a dish marquee." },
      { item: "delivery-001", anchor: "menu", role: "Меню", roleEn: "Menu", note: "Фильтры, блюда в каплях и кругах, степперы, закреплённая корзина с прогрессом.", noteEn: "Filters, dishes in drops and circles, steppers, a pinned cart with progress." },
      { item: "delivery-002", anchor: "builder", role: "Конструктор", roleEn: "Builder", note: "Слои падают в CSS-миску, калории, вес и цена считаются.", noteEn: "Layers drop into a CSS bowl; calories, weight and price add up." },
      { item: "delivery-003", anchor: "zones", role: "Зона доставки", roleEn: "Delivery zone", note: "SVG-карта кварталов, клик по зоне → минуты и стоимость.", noteEn: "An SVG block map, click a zone → minutes and cost." },
      { item: "delivery-004", anchor: "tracker", role: "Трекер", roleEn: "Tracker", note: "Четыре статуса, курьер едет по маршруту, «показать» проигрывает заказ.", noteEn: "Four statuses, a courier rides the route, “show” plays the order." },
