...
export const SCENARIOS: Scenario[] = [
  ...
  },
  {
    ...
    sections: [
      { item: "navbar-033", anchor: "", role: "Шапка", roleEn: "Header", note: "Плавающая стеклянная капсула: эквалайзер в лого, подсветка меню, живой индикатор созвона.", noteEn: "A floating glass capsule: an equalizer logo, a sliding menu highlight, a live call indicator." },
      { item: "hero-033", anchor: "top", role: "Первый экран", roleEn: "First screen", note: "Созвон на троих с субтитрами заканчивается — задача, сводка и решения сами разлетаются по сервисам.", noteEn: "A three-person call with captions ends — the task, summary and decisions fly out to the services." },
      ...
      { item: "bento-002", anchor: "integrations", role: "Интеграции", roleEn: "Integrations", note: "Маршрутизатор: входы, ядро продукта и выходы, по линиям бегут пакеты.", noteEn: "A router: inputs, the product core and outputs, packets run along the wires." },
      ...
      { item: "footer-032", anchor: "footer", role: "Подвал", roleEn: "Footer", note: "Карточка «сводка этой страницы», статус систем с пульсом, колонки ссылок.", noteEn: "A «recap of this page» card, a pulsing system status, link columns." },
    ],
  },
  {
    slug: "auto",
  ...
  },
  {
    ...
    en: "Language school",
    summary:
      "Сайт языковой онлайн-школы «Диалог» в духе тетради — тёплый белый, линовка, чернильно-синий и терракота: первый экран, где слово перелистывается между языками, а на тетрадном листе печатается диалог, тест уровня с шкалой A1–C1, как проходят занятия в bento со светящейся иглой таймлайна, расписание групп с «ближайшим стартом» от текущей даты, график словарного запаса с ползунком недель, преподаватели-полароиды с волной «послушать акцент», тарифы с переключателем формата и квитанцией с плавным счётчиком цены, отзывы с шкалой «до → после», пробный урок и подвал с контактами. Onest, Golos Text и Marck Script.",
    summaryEn:
      "An online language school site “Dialogue” in a notebook spirit — warm white, ruling, ink blue and terracotta: a hero where a word flips between languages and a dialogue types on a notebook page, a level test with an A1–C1 scale, how lessons go in a bento with a glowing timeline needle, a group schedule with the “next start” from today, a vocabulary graph with a week slider, teacher polaroids with a “hear the accent” wave, pricing with a format switch and a receipt with a smooth price counter, reviews with a “before → after” scale, a trial lesson and a footer with contacts. Onest, Golos Text and Marck Script.",
    ...
    sections: [
      { item: "navbar-039", anchor: "", role: "Шапка", roleEn: "Header", note: "Лого с рукописной подписью, чипы EN·ES·IT, при прокрутке превращается в плавающую капсулу.", noteEn: "A logo with a handwritten signature, EN·ES·IT chips, turns into a floating capsule on scroll." },
      ...
      { item: "faq-023", anchor: "faq", role: "Вопросы", roleEn: "FAQ", note: "Аккордеон с плюсом-крестиком.", noteEn: "An accordion with a plus-to-cross toggle." },
      { item: "footer-038", anchor: "footer", role: "Подвал", roleEn: "Footer", note: "Линовка, контакты, колонки.", noteEn: "Ruling, contacts, columns." },
    ],
  },
  {
    slug: "fintech",
