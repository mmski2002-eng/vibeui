...
--vibeui-testimonials-anim-001-fg:light-dark(oklch(0.19 0 266),oklch(0.98 0 266));
--vibeui-testimonials-anim-001-muted:light-dark(oklch(0.5 0 266),oklch(0.75 0 266));
--vibeui-testimonials-anim-001-border:light-dark(oklch(0.16 0 266 / 12%),oklch(1 0 0 / 12%));
--vibeui-testimonials-anim-001-card:light-dark(oklch(1 0 0),oklch(0.225 0 266));
--vibeui-testimonials-anim-001-accent:light-dark(oklch(0.55 0.19 264),oklch(0.72 0.163 264));
--vibeui-testimonials-anim-001-accent-fg:light-dark(oklch(0.99 0 266),oklch(0.17 0 266));
