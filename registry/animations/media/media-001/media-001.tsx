...
background:var(--vibeui-media-001-accent);color:var(--vibeui-media-001-accent-fg);
...
background:var(--vibeui-media-001-accent);
}
...
const BAR_HEIGHTS = [
  0.34, 0.6, 0.46, 0.78, 0.52, 0.9, 0.4, 0.66, 0.3, 0.74, 0.5, 0.86, 0.42,
  0.58, 0.94, 0.36, 0.68, 0.5, 0.82, 0.44, 0.62, 0.88, 0.32, 0.56, 0.76, 0.46,
  0.7, 0.38,
]
