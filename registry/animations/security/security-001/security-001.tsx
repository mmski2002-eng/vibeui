...
border-radius:1.5rem;border:1px solid var(--vibeui-security-001-border);
background:linear-gradient(to bottom,var(--vibeui-security-001-bg-top),var(--vibeui-security-001-bg-bottom));
}
