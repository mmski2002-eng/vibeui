...
--vibeui-stack-011-accent:light-dark(oklch(0.31 0 0),oklch(0.892 0 0));
...
[data-vibeui-block="stack-011"] [data-part="dot"][aria-current="true"]{width:1rem;background:var(--vibeui-stack-011-accent);color:oklch(from var(--vibeui-stack-011-accent) clamp(0,(0.62 - l) * 100,1) 0 0);}
